...
const Contact = () => {
    ...
    return (
        <>
            <Helmet>
                <title>오산 예약 문의 | 전화·카톡·텔레그램 서우실장</title>
                <meta name="description" content="오산 하이퍼블릭·가라오케 예약 문의. 전화/카톡/텔레그램 24시간 상담, 오산역·오산역 상권 픽업 안내." />
                <meta name="keywords" content="오산 예약, 오산 상담, 오산 하이퍼블릭 예약, 서우실장 연락처" />
                <meta property="og:title" content="오산 예약 문의 | 전화·카톡·텔레그램 서우실장" />
                <meta property="og:description" content="오산 하이퍼블릭·가라오케 예약 문의. 전화/카톡/텔레그램 24시간 상담, 오산역·오산역 상권 픽업 안내." />
                <meta property="og:image" content="https://osankaraoke.com/og-contact.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="오산 예약 상담 안내" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="오산 예약 문의 | 전화·카톡·텔레그램 서우실장" />
                <meta property="twitter:description" content="오산 하이퍼블릭·가라오케 예약 문의. 전화/카톡/텔레그램 24시간 상담, 오산역·오산역 상권 픽업 안내." />
                <meta property="twitter:image" content="https://osankaraoke.com/og-contact.jpg" />
                <link rel="canonical" href="https://osankaraoke.com/contact" />
            </Helmet>
            <SchemaJsonLd data={{
                "@context": "https://schema.org",
                "@type": "ContactPage",
                "name": "오산 서우실장 예약 문의",
                "description": "오산 24시간 실시간 예약 및 견적 상담",
                "url": "https://osankaraoke.com/contact"
            }} />
                ...
                <div className="container mx-auto px-4 pb-20 max-w-6xl relative z-10">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 animate-fade-in-up delay-100">
                            오산 가라오케·하이퍼블릭 실시간 예약 & <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600">문의하기</span>
                        </h1>
                        <p className="text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200">오산 상권 기준 빠른 예약/상담을 도와드립니다.<br />오산역·오산역 상권 픽업 포함, 24시간 연결됩니다.</p>
                    </div>
