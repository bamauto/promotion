...
const Home = () => {
    ...
    const venues = [
        { id: 'jeongja-highpub-guide', title: '하이퍼블릭', sub: '프라이빗 / 시크릿', img: '/highpublic_main.webp', desc: '트렌디한 분위기와 감각적인 서비스' },
        { id: 'jeongja-karaoke-guide', title: '가라오케', sub: '프리미엄 / 라운지', img: '/karaoke_main.webp', desc: '최신 음향 시설과 프라이빗 룸' },
        { id: 'jeongja-shirtsroom-guide', title: '셔츠룸', sub: '초이스 / 화이트셔츠', img: '/shirtsroom_main.webp', desc: '색다른 컨셉의 이색적인 경험' },
        { id: 'jeongja-kimono-room-guide', title: '기모노룸', sub: '이색 테마 / 코스프레', img: '/kimonoroom_main.webp', desc: '매혹적인 일본 전통 의상 테마' },
        { id: 'jeongja-room-salon-guide', title: '룸살롱', sub: '정통 / 비즈니스', img: '/roomsalon_main.webp', desc: '성공적인 비즈니스를 위한 격조 높은 공간' },
        { id: 'jeongja-hostbar-guide', title: '호빠', sub: '프리미엄 / 여성전용', img: '/hostbar_main.webp', desc: '여성 고객을 위한 품격있는 서비스' }
    ];
            ...
            <section className="py-24 bg-slate-950 overflow-hidden">
                ...
                <div className="relative flex overflow-hidden">
                    <div className="flex animate-infinite-scroll whitespace-nowrap group hover:[animation-play-state:paused]">
                        ...
                        {[
                            { src: '/partner/home-partner-01.webp', alt: '정자 가라오케 프리미엄 매니저 - 정자역 VIP 서비스' },
                            { src: '/partner/home-partner-02.webp', alt: '정자 하이퍼블릭 최고급 매니저 - 정자동 럭셔리' },
                            { src: '/partner/home-partner-03.webp', alt: '정자 가라오케 VIP 매니저 - 분당구 프리미엄 파트너' },
                            { src: '/partner/home-partner-04.webp', alt: '정자 하이퍼블릭 엄선 파트너 - 서울근교 베스트 초이스' },
                            { src: '/partner/home-partner-01.webp', alt: '정자 가라오케 프리미엄 매니저 - 정자역 VIP 서비스' },
                            { src: '/partner/home-partner-02.webp', alt: '정자 하이퍼블릭 최고급 매니저 - 정자동 럭셔리' },
                            { src: '/partner/home-partner-03.webp', alt: '정자 가라오케 VIP 매니저 - 분당구 프리미엄 파트너' },
                            { src: '/partner/home-partner-04.webp', alt: '정자 하이퍼블릭 엄선 파트너 - 서울근교 베스트 초이스' },
