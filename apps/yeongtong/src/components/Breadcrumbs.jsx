...
const routeNameMap = {
    'yeongtong-highpub-guide': '하이퍼블릭',
    'yeongtong-karaoke-guide': '가라오케',
    'yeongtong-shirtsroom-guide': '셔츠룸',
    'yeongtong-kimono-room-guide': '기모노룸',
    'yeongtong-room-salon-guide': '룸살롱',
    'yeongtong-hostbar-guide': '호빠',
    'yeongtong-entertainment-price-guide': '가격 가이드',
    'yeongtong-entertainment-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    const schemaItems = [
        {
            ...
            "position": 1,
            "name": "Home",
            "item": "https://yeongtongkaraoke.com/"
        }
    ];
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://yeongtongkaraoke.com${routeTo}`
        });
    });
