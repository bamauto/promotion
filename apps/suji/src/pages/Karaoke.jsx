    ...
    karaoke: [
        {
            ...
            desc: '수지역에서 접근 좋은 파티형 가라오케. 수지 신도시 직장인 회식/모임에 맞춘 대형 룸.',
            features: ['대형 룸', '음향 특화', '수지역 접근', '회식 추천'],
            img: '/suji-highpublic-2.webp',
            imgAlt: '수지 가라오케 수지역 추천',
        },
        {
            id: 'k-2',
            name: '수지 가라오케 B점',
            ...
            location: '수지호수공원 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지호수공원 라운지 톤 가라오케. 음향 퀄리티와 조용한 대화 모두 만족.',
            features: ['라운지 무드', '고급 사운드', '수지호수공원 중심', '프라이빗'],
            img: '/suji-shirtsroom-1.webp',
            imgAlt: '수지 가라오케 수지호수공원 추천',
        },
        {
            id: 'k-3',
            name: '수지 가라오케 C점',
            ...
            location: '수지센트럴파크 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지센트럴파크 인근 실속형 가라오케. 부담 낮추고 즐기는 캐주얼 코스.',
            features: ['실속 구성', '부담 낮음', '수지센트럴파크 인근', '캐주얼'],
            img: '/suji-roomsalon-2.webp',
            imgAlt: '수지 가라오케 수지센트럴파크 추천',
        },
        {
            id: 'k-4',
            name: '수지 가라오케 D점',
            ...
            location: '상현역 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '상현역 인근 프라이빗 VIP 룸. 조용한 자리나 소규모 모임에 적합.',
            features: ['VIP 룸', '조용한 대화', '상현역 인근', '소규모'],
            img: '/suji-nightlife-1.webp',
            imgAlt: '수지 가라오케 상현역 추천',
        },
        {
            id: 'k-5',
            name: '수지 가라오케 E점',
            ...
            location: '신봉동 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지 신봉동에서 조용히 찾는 시크릿 벙커 컨셉. 외부 노출 없이 운영되어 보안과 프라이버시에 민감한 일정에 적합합니다.',
            features: ['비밀 통로', '보안 철저', 'VIP 케어', '예약제'],
            img: '/suji-entertainment-main.webp',
            imgAlt: '수지 가라오케 E점 시크릿 벙커'
        },
        {
            id: 'k-6',
            name: '수지 가라오케 F점',
            ...
            location: '청계동 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지 테크노밸리·기업 미팅 후 방문에 맞춘 비즈니스 라인. 깔끔한 진행과 맞춤 케어로 모임의 품격을 유지합니다.',
            features: ['법인 카드', '세금 계산서', '접대 전문', '대리 운전'],
            img: '/suji-hostbar-1.webp',
            imgAlt: '수지 가라오케 F점 비즈니스 클럽'
        }
    ]
};
...
const Karaoke = () => {
    const faqList = [
    {
        question: "수지 가라오케 1인 방문도 가능한가요?",
        answer: "네, 가능합니다. 수지 상권은 수지 신도시 직장인 이용이 많아 모던한 응대로 1:1 시작도 부담 없이 안내합니다."
    },
    {
        question: "수지 가라오케 픽업은 어디까지 지원되나요?",
        answer: "픽업은 죽전역, 수지구청역, 성복동, 상현역 중심으로 운영됩니다. 정확한 동선은 예약 시 조율해 드립니다."
    },
    {
        question: "수지 가라오케 주대/TC 기준이 궁금해요.",
        answer: "주대 18만원 이상, TC 10만원 이상 기준이며 시간·코스·인원에 따라 달라질 수 있습니다. 상세는 문의 부탁드립니다."
    }
];

    const sections = [
        { id: "features", title: "1. 수지 가라오케 특징" },
    ...
    const serviceSchema = generateServiceSchema(
        "Karaoke",
        "수지 가라오케 예약 안내. 수지역·수지센트럴파크 중심 파티룸, 주대 18만원 이상/TC 10만원 이상.",
        "https://sujikaraoke.com/suji-karaoke-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>수지 가라오케 추천 | 죽전역·수지구청역 인기 노래방</title>
                <meta name="description" content="수지 대표 가라오케 비교. 죽전 카페거리 인근, 최신 음향 시설. 단체석·커플석 완비. 분당·판교 직장인 회식 맞춤 ☎ 010-2626-4833" />
                <meta name="keywords" content="수지 가라오케, 죽전역 가라오케, 수지구청역 노래방, 성복동 가라오케, 신분당선 노래방, 수지 회식 장소" />
                <meta property="og:title" content="수지 가라오케 추천 | 죽전역·수지구청역 인기 노래방" />
                <meta property="og:description" content="수지 대표 가라오케 비교. 죽전 카페거리 인근, 최신 음향. 분당·판교 직장인 회식 맞춤. 단체석·커플석 완비." />
                <meta property="og:image" content="https://sujikaraoke.com/og-karaoke.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="수지 가라오케 추천 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="수지 가라오케 추천 | 죽전역·수지구청역 인기 노래방" />
                <meta property="twitter:description" content="수지 대표 가라오케 비교. 죽전 카페거리 인근, 최신 음향. 단체석·커플석 완비." />
                <meta property="twitter:image" content="https://sujikaraoke.com/og-karaoke.jpg" />
                <link rel="canonical" href="https://sujikaraoke.com/suji-karaoke-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="수지 가라오케 가이드" subtitle="Luxury & Fun" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">수지 가라오케는 수지역·수지센트럴파크 중심 파티룸 위주 구성입니다.<br />회식/모임에 맞춘 음향 세팅과 유연한 룸 타입을 안내합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="features" title="1. 수지 가라오케의 특징">
                        <p>
                            수지 가라오케는 단순한 노래방을 넘어선 <strong>'토탈 엔터테인먼트 공간'</strong>을 지향합니다. 강남의 고급 가라오케 시스템을 그대로 도입하여,
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-purple-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 수지 가라오케 추천 TOP 6</h2>
                        </div>
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-purple-500" /> 수지 가라오케 갤러리
                            </h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    { src: '/partner/kr-gallery-01.webp', alt: '수지 가라오케 프리미엄 매니저 - 수지역 VIP 서비스' },
                                    { src: '/partner/kr-gallery-02.webp', alt: '수지 가라오케 최고급 파트너 - 메타폴리스 럭셔리 룸' },
                                    { src: '/partner/kr-gallery-03.webp', alt: '수지 가라오케 VIP 매니저 - 수지신도시 프리미엄' },
                                    { src: '/partner/kr-gallery-04.webp', alt: '수지 가라오케 프리미엄 서비스 - 수지 24시간' },
                                ].map((img, idx) => (
                    ...
                    <ContentBlock id="pricing" title="3. 이용 가격 및 시스템 안내">
                        <p>
                            수지 가라오케는 투명한 정찰제로 운영됩니다.
                            <strong>양주 SET</strong> 문의가 가장 많으며, 수지역·호수공원 라인 기준으로 인원/시간에 따라 추가 안내됩니다.
                        </p>
                            ...
                            <table className="w-full text-left border-collapse mt-2">
                                <thead>
                                    <tr className="border-b border-slate-700 text-purple-400">
                                        <th className="py-3 px-4">세트 메뉴 (수지)</th>
                                        <th className="py-3 px-4">구성</th>
                                        <th className="py-3 px-4">가격 (예상·수지)</th>
                                    </tr>
                                </thead>
                    ...
                    <div id="faq" className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
                        ...
                        <div className="bg-purple-900/10 p-8 rounded-2xl border border-purple-500/20">
                            ...
                            <div className="mt-6 text-center">
                                <Link to="/suji-karaoke-guide/faq" className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300 font-bold transition-colors">
                                    수지 더 많은 질문과 답변 보기 <ChevronRight size={18} />
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-800 to-indigo-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오늘 밤, 수지에서 당신이 무대의 주인공입니다</h2>
                        <p className="text-purple-100 mb-8 max-w-2xl mx-auto relative z-10">
                            수지 최고의 시설에서 터질 듯한 사운드와 함께 스트레스를 풀어보세요.<br />
                            수지 1등 가라오케 예약은 서우실장이 가장 빠르고 저렴합니다.
                        </p>
