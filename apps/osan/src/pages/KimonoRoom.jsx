    ...
    kimonoRoom: [
        {
            ...
            desc: '오산역 테마형 기모노룸. 일본풍 무드와 포토 포인트.',
            features: ['테마 의상', '포토존', '오산역 접근', '이색 무드'],
            img: venueImg1,
            imgAlt: '오산 기모노룸 오산역 추천',
        },
        {
            id: 'km-2',
            name: '오산구 퓨전 기모노룸',
            ...
            location: '오산역 상권 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '오산역 상권 인근 모던 기모노룸. 고급스러운 무드와 세련된 연출.',
            features: ['모던 테마', '감각 연출', '오산역 상권 중심', '프라이빗'],
            img: venueImg2,
            imgAlt: '오산 기모노룸 오산역 상권 추천',
        }
    ]
};
...
const KimonoRoom = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Kimono Room",
        "오산 기모노룸 예약 안내. 오산역·삼성전자 오산캠퍼스 테마, 주대 18만원 이상/TC 10만원 이상.",
        "https://osankaraoke.com/osan-kimono-room-guide",
        "180000"
    );
        ...
        <>
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="오산 기모노룸 가이드" subtitle="Exotic Atmosphere" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">오산 기모노룸은 오산역·삼성전자 오산캠퍼스 테마 중심으로 이색 무드를 제공합니다.<br />포토 포인트와 테마 연출을 함께 즐기실 수 있습니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>
                    ...
                    <ContentBlock id="definition" title="1. 기모노룸의 매력">
                        ...
                        <p>
                            ...
                            마치 일본 여행을 온 듯한 착각을 불러일으킵니다. 중요 바이어 접대나 기억에 남는 파티 장소로 강력 추천하는 <strong>오산의 히든 플레이스</strong>입니다.
                        </p>
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h2 className="text-3xl font-bold text-white">2. 오산 기모노룸 추천 목록</h2>
                        </div>
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-rose-500" /> 오산 기모노룸 갤러리
                            </h3>
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                {[
                                    { src: '/partner/km-gallery-01.webp', alt: '오산 기모노룸 전통 의상 매니저 - 오산역 테마룸' },
                                    { src: '/partner/km-gallery-02.webp', alt: '오산 기모노룸 프리미엄 서비스 - 오산구 유카타 컨셉' },
                                    { src: '/partner/km-gallery-03.webp', alt: '오산 기모노룸 VIP 파트너 - 오산구 이색 체험' },
                                    { src: '/partner/km-gallery-04.webp', alt: '오산 기모노룸 최고급 매니저 - 서울근교 일본풍 테마' },
                                    { src: '/partner/km-gallery-05.webp', alt: '오산 기모노룸 럭셔리 서비스 - 오산 프리미엄' },
                                ].map((img, idx) => (
                    ...
                    <div className="bg-gradient-to-r from-red-800 to-orange-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오산에서 지루한 일상에 색다른 파격을</h2>
                        <p className="text-red-100 mb-8 max-w-2xl mx-auto relative z-10">
                            경험해보지 못한 새로운 즐거움.<br />
                            오산 기모노룸에서 잊지 못할 추억을 만들어 드립니다.
                        </p>
