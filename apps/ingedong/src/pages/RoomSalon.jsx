    ...
    roomSalon: [
        {
            ...
            imgAlt: '인계동 로얄 비즈니스 룸살롱'
        },
        {
            id: 'rs-2',
            name: '인계동 룸살롱 - 레거시 클럽',
            type: 'Traditional Luxury',
            location: '인계동 영통역 AK플라자 인근',
...
const RoomSalon = () => {
    ...
    return (
        <>
            <Helmet>
                <title>인계동 룸살롱 비즈니스 접대 가이드 | 효과적인 선택과 매너</title>
                <meta name="description" content="인계동 고급 룸살롱 선택 기준 및 효과적 활용법 | 바이어 접대·클라이언트 관계 구축 전략 | 비즈니스 파트너 선정 가이드 | 접대 매너·에티켓·비용 효율화 팁" />
