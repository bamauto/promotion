...
const routeNameMap = {
    'ingedong-karaoke-guide': '가라오케',
    'ingedong-hyperpublic-guide': '하이퍼블릭',
    'ingedong-shirtsroom-guide': '셔츠룸',
    'ingedong-kimono-room-guide': '기모노룸',
    'ingedong-room-salon-guide': '룸살롱',
    'ingedong-hostbar-guide': '호빠',
    'ingedong-price-guide': '가격 가이드',
    'ingedong-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    const schemaItems = [
        {
            ...
            "position": 1,
            "name": "Home",
            "item": "https://www.ingedongkaraoke.com/"
        }
    ];
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://www.ingedongkaraoke.com${routeTo}`
        });
    });
