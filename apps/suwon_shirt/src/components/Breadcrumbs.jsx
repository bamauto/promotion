...
const routeNameMap = {
    'suwon-shirt-highpub-guide': '하이퍼블릭',
    'suwon-shirt-karaoke-guide': '가라오케',
    'suwon-shirt-shirtsroom-guide': '셔츠룸',
    'suwon-shirt-kimono-room-guide': '기모노룸',
    'suwon-shirt-room-salon-guide': '룸살롱',
    'suwon-shirt-hostbar-guide': '호빠',
    'suwon-shirt-price-guide': '가격 가이드',
    'suwon-shirt-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://suwonshirt.com${routeTo}`
        });
    });
