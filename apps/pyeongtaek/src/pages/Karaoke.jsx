    ...
    karaoke: [
        {
            ...
            desc: '평택역에서 접근 좋은 파티형 가라오케. 평택·평택 테크 직장인 회식/모임에 맞춘 대형 룸.',
            features: ['대형 룸', '음향 특화', '평택역 접근', '회식 추천'],
            img: venueImg1,
            imgAlt: '평택 가라오케 평택역 추천',
        },
        {
            id: 'k-2',
            name: '평택 럭셔리 가라오케',
            ...
            location: '평택역 상권 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '평택역 상권 라운지 톤 가라오케. 음향 퀄리티와 조용한 대화 모두 만족.',
            features: ['라운지 무드', '고급 사운드', '평택역 상권 중심', '프라이빗'],
            img: venueImg2,
            imgAlt: '평택 가라오케 평택역 상권 추천',
        }
    ]
};
...
const Karaoke = () => {
    ...
    return (
        <>
            <Helmet>
                <title>평택 가라오케 TOP 추천 | 평택역·평택 테크 직장인 필수</title>
                <meta name="description" content="평택 가라오케 추천 가이드. 평택역·평택 산업단지 중심 프리미엄 파티룸. 고급 음향시스템 & 호텔급 안주. 주대 18만원 이상, TC 10만원 이상. 상담 010-2626-4833" />
                <meta name="keywords" content="평택 가라오케, 평택 가라오케 예약, 평택 가라오케 가격, 평택 하이퍼블릭" />
                <meta property="og:title" content="평택 가라오케 TOP 추천 | 평택역·평택 테크 직장인 필수" />
                <meta property="og:description" content="평택 가라오케 추천 가이드. 평택역·평택 산업단지 중심 프리미엄 파티룸. 고급 음향시스템 & 호텔급 안주. 주대 18만원 이상, TC 10만원 이상. 상담 010-2626-4833" />
                <meta property="og:image" content="https://pt-karaoke.com/og-karaoke.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="평택 가라오케 추천 가이드" />
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="평택 가라오케 101: 용도별 선택 가이드" subtitle="비교와 선택" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">평택 가라오케는 평택역·평택 산업단지 중심 파티룸 위주 구성입니다.<br />회식/모임에 맞춘 음향 세팅과 유연한 룸 타입을 안내합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="features" title="1. 평택 가라오케의 특징">
                        <p>
                            평택 가라오케는 단순한 노래방을 넘어선 <strong>'토탈 엔터테인먼트 공간'</strong>을 지향합니다. 강남의 고급 가라오케 시스템을 그대로 도입하여,
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-purple-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 평택 가라오케 추천 TOP 6</h2>
                        </div>
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-purple-500" /> 평택 가라오케 갤러리
                            </h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    { src: '/partner/kr-gallery-01.webp', alt: '평택 가라오케 프리미엄 매니저 - 평택역 VIP 서비스' },
                                    { src: '/partner/kr-gallery-02.webp', alt: '평택 가라오케 최고급 파트너 - 평택 럭셔리 룸' },
                                    { src: '/partner/kr-gallery-03.webp', alt: '평택 가라오케 VIP 매니저 - 평택 프리미엄' },
                                    { src: '/partner/kr-gallery-04.webp', alt: '평택 가라오케 프리미엄 서비스 - 서울근교 24시간' },
                                ].map((img, idx) => (
                    ...
                    <ContentBlock id="pricing" title="3. 이용 가격 및 시스템 안내">
                        <p>
                            평택 가라오케는 투명한 정찰제로 운영됩니다.
                            <strong>양주 SET</strong>로 시작하는 경우가 많으며, 평택역 상권 라인 기준으로 인원/시간에 따라 안내됩니다.
                        </p>
                            ...
                            <table className="w-full text-left border-collapse mt-2">
                                <thead>
                                    <tr className="border-b border-slate-700 text-purple-400">
                                        <th className="py-3 px-4">세트 메뉴 (평택)</th>
                                        <th className="py-3 px-4">구성</th>
                                        <th className="py-3 px-4">가격 (예상·평택)</th>
                                    </tr>
                                </thead>
                    ...
                    <div className="bg-gradient-to-r from-purple-800 to-indigo-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오늘 밤, 평택에서 당신이 무대의 주인공입니다</h2>
                        <p className="text-purple-100 mb-8 max-w-2xl mx-auto relative z-10">
                            평택 최고의 시설에서 터질 듯한 사운드와 함께 스트레스를 풀어보세요.<br />
                            평택 1등 가라오케 예약은 서우실장이 가장 빠르고 저렴합니다.
                        </p>
