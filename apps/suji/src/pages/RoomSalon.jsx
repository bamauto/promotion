    ...
    roomSalon: [
        {
            ...
            desc: '수지역 인근 비즈니스 룸살롱. 수지 신도시 직장인 접대/회의에 맞춘 세팅.',
            features: ['비즈니스 세팅', '조용한 룸', '수지역 접근', '접대 중심'],
            img: '/suji-shirtsroom-hero.webp',
            imgAlt: '수지 룸살롱 수지역 추천',
        },
        {
            id: 'rs-2',
            name: '수지 룸살롱 - 레거시 클럽',
            ...
            location: '수지호수공원 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지호수공원 중심 하이엔드 룸살롱. 품격 있는 서비스와 프라이빗 룸.',
            features: ['하이엔드 서비스', '프라이빗 룸', '수지호수공원 중심', '품격'],
            img: '/suji-karaoke-1.webp',
            imgAlt: '수지 룸살롱 수지호수공원 추천',
        }
    ]
};
...
const RoomSalon = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Suji Room Salon",
        "수지 룸살롱 예약 안내. 수지구청역·성복동 비즈니스 라인, 주대 18만원 이상/TC 10만원 이상.",
        "https://sujikaraoke.com/suji-room-salon-guide",
        "200000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>수지 룸살롱 | 분당 생활권 비즈니스 접대</title>
                <meta name="description" content="수지 룸살롱 예약. 분당선 10분, 신분당선 직결. 반도체 벨트 VVIP 접대 전문. 고급 인테리어·프라이빗 룸 ☎ 010-2626-4833" />
                <meta name="keywords" content="수지 룸살롱, 수지구청역 룸살롱, 죽전 룸살롱, 성복동 룸살롱, 신분당선 접대, 분당 룸살롱" />
                <meta property="og:title" content="수지 룸살롱 | 분당 생활권 비즈니스 접대" />
                <meta property="og:description" content="수지 룸살롱 예약. 분당선+신분당선 직결. 반도체 벨트 VVIP 접대 전문. 고급 인테리어·프라이빗 룸 완비." />
                <meta property="og:image" content="https://sujikaraoke.com/og-room-salon.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="수지 룸살롱 예약 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="수지 룸살롱 | 분당 생활권 비즈니스 접대" />
                <meta property="twitter:description" content="수지 룸살롱 예약. 분당선 10분, 신분당선 직결. 반도체 벨트 VVIP 접대 전문." />
                <meta property="twitter:image" content="https://sujikaraoke.com/og-room-salon.jpg" />
                <link rel="canonical" href="https://sujikaraoke.com/suji-room-salon-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="수지 룸살롱 예약 & 가이드" subtitle="Traditional Luxury" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">수지 룸살롱은 수지역·수지호수공원 중심 비즈니스 라인에 맞춘 프라이빗 세팅입니다.<br />조용한 대화와 접대를 우선으로 원하는 스타일을 맞춰드립니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="definition" title="1. 수지 룸살롱이란? (Introduction)">
                        <p>
                    ...
                    <div id="recommendation" className="mb-24">
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-amber-500" /> 수지 룸살롱 갤러리
                            </h3>
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    { src: '/partner/rs-gallery-01.webp', alt: '수지 룸살롱 VIP 매니저 - 수지역 비즈니스 접대' },
                                    { src: '/partner/rs-gallery-02.webp', alt: '수지 룸살롱 최고급 파트너 - 메타폴리스 프리미엄' },
                                    { src: '/partner/rs-gallery-03.webp', alt: '수지 룸살롱 프리미엄 서비스 - 수지신도시 정통' },
                                ].map((img, idx) => (
                    ...
                    <div id="faq" className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
                        <div className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800">
                            ...
                            <ul className="space-y-4 text-slate-300 font-light">
                                ...
                                <li className="flex gap-3">
                                    <CheckCircle className="text-amber-500 w-5 h-5 flex-shrink-0" />
                                    <span><strong>프라이빗 룸</strong>: 수지호수공원 인근 비즈니스 일정은 방음 강화 룸을 우선 제공합니다.</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-amber-900/10 p-8 rounded-2xl border border-amber-500/20">
                            ...
                            <div className="mt-6 text-center">
                                <Link to="/suji-room-salon-guide/faq" className="inline-flex items-center gap-2 text-amber-500 hover:text-amber-400 font-bold transition-colors">
                    ...
                    <div className="bg-gradient-to-r from-amber-600 to-amber-700 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">수지에서 귀하의 품격에 어울리는 곳</h2>
                        <p className="text-amber-100 mb-8 max-w-2xl mx-auto relative z-10">
                            중요한 자리일수록 전문가에게 맡기셔야 합니다.<br />
                            수지 정통 룸살롱 예약 1위, 서우실장이 책임지겠습니다.
                        </p>
