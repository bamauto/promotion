    ...
    kimonoRoom: [
        {
            ...
            imgAlt: '안양 기모노룸 A점 이색 테마'
        },
        {
            id: 'km-2',
            name: '안양 기모노룸 B점',
            type: 'Modern Fusion',
            location: '평촌 신도시 5번 출구',
            price: '사케 무제한',
...
const KimonoRoom = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Kimono Room",
        "안양 기모노룸 예약 및 가격. 기모노 의상 테마의 이색 프리미엄 룸살롱.",
    ...
    return (
        <>
            <Helmet>
                <title>안양 기모노룸 완벽가이드 | 이색접대·특별한밤 BEST 2곳</title>
                <meta name="description" content="안양 기모노룸 가이드. 기모노·유카타 의상 테마·일본감성. 안양 전문직 글로벌기업 바이어접대·파티·포토존·사케서빙. 평촌역·범계역·평촌 신도시·동안구. 비즈니스 성공률 높음. 투명정찰제 | 24시간 ☎ 010-2626-4833" />
                <meta name="keywords" content="안양 기모노룸, 안양 기모노 가격, 안양 일본식 접대, 평촌역·범계역 기모노룸, 평촌 신도시 기모노, 안양 유카타, 안양 사케바, 안양 바이어접대 기모노, 안양 특별한날 장소, 안양 포토존 클럽" />
                <meta property="og:title" content="안양 기모노룸 완벽가이드 | 이색접대·특별한밤" />
                <meta property="og:description" content="기모노·유카타 의상 테마·일본감성. 글로벌기업 바이어접대·파티·포토존" />
                ...
                <meta property="twitter:title" content="안양 기모노룸 | NO.1 서우실장" />
                ...
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    ...
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">
                            안양 도심 속에서 만나는 <strong className="text-rose-400">작은 일본</strong>.<br />
