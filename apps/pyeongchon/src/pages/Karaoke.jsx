    ...
    karaoke: [
        {
            ...
            img: '/partner/kr-gallery-01.webp',
            imgAlt: '평촌 가라오케 범계역 추천',
        },
        {
            id: 'k-2',
            name: '범계 로데오 라운지',
            ...
            img: '/partner/kr-gallery-02.webp',
            imgAlt: '평촌 가라오케 평촌역 추천',
        },
        {
            id: 'k-3',
            name: '인덕원 IT 접대 전문',
            ...
            img: '/partner/kr-gallery-03.webp',
        ...
        },
        {
            ...
            img: '/partner/kr-gallery-04.webp',
        ...
        },
        {
            ...
            location: '평촌역 도보 3분',
            price: '주대 18만원 이상 · TC 10만원 이상 (자세한 상담)',
            desc: '평촌 유일 Bose 전관 음향 시스템 도입. 노래 좋아하시는 분들께 강력 추천. 평촌 신도시 중년층·40대 동호회 정기 모임 단골 업소. 금연 룸 5개 완비.',
            features: ['Bose 음향', '금연 룸 완비', '동호회 환영', '정기 예약 할인'],
            img: '/partner/hp-gallery-05.webp',
        ...
        },
        {
            ...
            img: '/partner/hp-gallery-06.webp',
...
const Karaoke = () => {
    const faqList = [
    {
        question: "범계 로데오거리에서 가라오케 찾기 어렵지 않나요?",
        answer: "범계역 3번 출구에서 도보 3분 거리에 제휴 가라오케가 밀집해 있습니다. 처음 방문하시면 서우실장이 직접 출구에서 픽업해 안내해 드립니다."
    },
    {
        question: "평촌학원가 회식 후 2차로 적합한 곳 있나요?",
        answer: "평촌학원가에서 도보 10분 거리에 제휴 가라오케가 있습니다. 학원 원장님·강사진 단체회식 전용 대형룸(15인 이상)도 완비되어 있어 단체 2차에 최적입니다."
    },
    {
        question: "인덕원 IT단지 퇴근 후 바로 방문 가능한가요?",
        answer: "인덕원역에서 직접 픽업 서비스가 가능합니다. 퇴근 시간(6시~8시) 예약 시 '인덕원 픽업' 요청 주시면 5분 내 도착합니다."
    },
    {
        question: "평촌 가라오케 40대 동호회 모임 가능한가요?",
        answer: "평촌 신도시 중년층 단골이 많습니다. 정기 모임 시 10% 할인 + 금연룸 우선 배정 혜택이 있으니 예약 시 '동호회 모임'이라고 말씀해 주세요."
    }
];

    const sections = [
        { id: "features", title: "1. 평촌 가라오케 특징" },
    ...
    const serviceSchema = generateServiceSchema(
        "Karaoke",
        "평촌 가라오케 예약 안내. 범계역·인덕원역 중심 파티룸, 주대 18만원 이상/TC 10만원 이상.",
        "https://pc-karaoke.com/pyeongchon-karaoke-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>평촌 가라오케 예약 | 범계역·인덕원역 추천</title>
                <meta name="description" content="평촌 가라오케 추천 가이드. 범계역·인덕원역 중심 파티/모임 룸, 평촌·범계 직장인 회식 맞춤. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta name="keywords" content="평촌 가라오케, 평촌 가라오케 예약, 평촌 가라오케 가격, 평촌 하이퍼블릭" />
                <meta property="og:title" content="평촌 가라오케 예약 | 범계역·인덕원역 추천" />
                <meta property="og:description" content="평촌 가라오케 추천 가이드. 범계역·인덕원역 중심 파티/모임 룸, 평촌·범계 직장인 회식 맞춤. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="og:image" content="https://pc-karaoke.com/og-karaoke.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="평촌 가라오케 추천 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="평촌 가라오케 예약 | 범계역·인덕원역 추천" />
                <meta property="twitter:description" content="평촌 가라오케 추천 가이드. 범계역·인덕원역 중심 파티/모임 룸, 평촌·범계 직장인 회식 맞춤. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="twitter:image" content="https://pc-karaoke.com/og-karaoke.jpg" />
                <link rel="canonical" href="https://pc-karaoke.com/pyeongchon-karaoke-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="평촌 가라오케 가이드" subtitle="Luxury & Fun" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">평촌 가라오케는 범계역·인덕원역 중심 파티룸 위주 구성입니다.<br />회식/모임에 맞춘 음향 세팅과 유연한 룸 타입을 안내합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="features" title="1. 평촌 가라오케의 특징">
                        <p>
                            평촌 가라오케는 단순한 노래방을 넘어선 <strong>'토탈 엔터테인먼트 공간'</strong>을 지향합니다. 강남의 고급 가라오케 시스템을 그대로 도입하여,
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-purple-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 평촌 가라오케 추천 TOP 6</h2>
                        </div>
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-purple-500" /> 평촌 가라오케 갤러리
                            </h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    { src: '/partner/kr-gallery-01.webp', alt: '평촌 가라오케 프리미엄 매니저 - 평촌역·범계역 VIP 서비스' },
                                    { src: '/partner/kr-gallery-02.webp', alt: '평촌 가라오케 최고급 파트너 - 평촌학원가 럭셔리 룸' },
                                    { src: '/partner/kr-gallery-03.webp', alt: '평촌 가라오케 VIP 매니저 - 평촌 신도시 프리미엄' },
                                    { src: '/partner/kr-gallery-04.webp', alt: '평촌 가라오케 프리미엄 서비스 - 평촌 24시간' },
                                ].map((img, idx) => (
                            ...
                            <table className="w-full text-left border-collapse mt-2">
                                <thead>
                                    <tr className="border-b border-slate-700 text-purple-400">
                                        <th className="py-3 px-4">세트 메뉴 (평촌)</th>
                                        <th className="py-3 px-4">구성</th>
                                        <th className="py-3 px-4">가격 (예상·평촌)</th>
                                    </tr>
                                </thead>
                    ...
                    <div id="faq" className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
                        ...
                        <div className="bg-purple-900/10 p-8 rounded-2xl border border-purple-500/20">
                            ...
                            <div className="mt-6 text-center">
                                <Link to="/pyeongchon-karaoke-guide/faq" className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300 font-bold transition-colors">
                                    평촌 더 많은 질문과 답변 보기 <ChevronRight size={18} />
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-800 to-indigo-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오늘 밤, 평촌에서 당신이 무대의 주인공입니다</h2>
                        <p className="text-purple-100 mb-8 max-w-2xl mx-auto relative z-10">
                            평촌 최고의 시설에서 터질 듯한 사운드와 함께 스트레스를 풀어보세요.<br />
                            평촌 1등 가라오케 예약은 서우실장이 가장 빠르고 저렴합니다.
                        </p>
