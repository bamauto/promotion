    ...
    roomSalon: [
        {
            ...
            imgAlt: '정자 로얄 비즈니스 룸살롱'
        },
        {
            id: 'rs-2',
            name: '정자 룸살롱 - 레거시 클럽',
            type: 'Traditional Luxury',
            location: '정자 분당역 AK플라자 인근',
...
const RoomSalon = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Jeongja Room Salon",
        "정자 최고급 정통 룸살롱 예약 및 비즈니스 접대 가이드.",
        "https://www.jengjakaraoke.com/jeongja-room-salon-guide",
        "200000"
    );
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image" content="https://www.jengjakaraoke.com/og-room-salon.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="정자 룸살롱 비즈니스 접대 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="정자 룸살롱 접대 가이드" />
                <meta property="twitter:description" content="비즈니스 접대 전략 | 라운지 선택 | 에티켓 안내" />
                <meta property="twitter:image" content="https://www.jengjakaraoke.com/og-room-salon.jpg" />
                <link rel="canonical" href="https://www.jengjakaraoke.com/jeongja-room-salon-guide" />
            </Helmet>
                        ...
                        <div className="mt-16">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    ...
                                    { src: '/partner/rs-gallery-03.webp', alt: '정자 룸살롱 프리미엄 서비스 - 분당구 정통' },
                                ].map((img, idx) => (
