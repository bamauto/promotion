...
const HighPublicFAQ = () => {
    const faqList = [
    {
        question: "수지 하이퍼블릭과 퍼블릭의 차이는 무엇인가요?",
        answer: "하이퍼블릭은 퍼블릭 대비 인테리어와 서비스 퀄리티를 높인 타입입니다. 수지 신도시 직장인 이용이 많아 조용한 대화와 프라이빗 동선에 초점을 둡니다."
    },
    {
        question: "혼자 방문해도 괜찮나요?",
        answer: "네, 1인 방문도 환영합니다. 수지 상권 특성상 1:1 요청이 많아 모던한 톤으로 안내드립니다."
    },
    {
        question: "픽업은 어디까지 가능한가요?",
        answer: "픽업은 죽전역, 수지구청역, 성복동, 상현역 중심으로 운영됩니다. 예약 시 동선을 맞춰드립니다."
    },
    {
    ...
    return (
        <>
            <Helmet>
                <title>수지 하이퍼블릭 FAQ | 가격·픽업·예약 안내</title>
                <meta name="description" content="수지 하이퍼블릭 이용 전 필독 FAQ. 주대/TC 기준, 픽업 범위, 예약 팁을 정리했습니다." />
                <meta name="keywords" content="수지 하이퍼블릭 FAQ, 수지 하이퍼블릭 가격, 수지 하이퍼블릭 예약" />
                <link rel="canonical" href="https://sujikaraoke.com/suji-highpub-guide/faq" />
            </Helmet>
                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="mt-16 text-center">
                        ...
                        <div className="flex flex-col md:flex-row justify-center gap-4">
                            ...
                            <Link to="/suji-highpub-guide" className="bg-slate-800 hover:bg-slate-700 text-white font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-2 transition-all">
                                <ChevronRight size={20} /> 수지 하이퍼블릭 메인으로
                            </Link>
                        </div>
                    </div>
                </div>
