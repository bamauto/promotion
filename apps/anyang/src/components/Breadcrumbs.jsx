...
const routeNameMap = {
    'anyang-highpub-guide': '하이퍼블릭',
    'anyang-karaoke-guide': '가라오케',
    'anyang-shirtsroom-guide': '셔츠룸',
    'anyang-kimono-room-guide': '기모노룸',
    'anyang-room-salon-guide': '룸살롱',
    'anyang-hostbar-guide': '호빠',
    'anyang-entertainment-price-guide': '가격 가이드',
    'anyang-entertainment-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://anyangkaraoke.com${routeTo}`
        });
    });
