...
const HighPublicFAQ = () => {
    const faqList = [
        ...
        },
        {
            ...
            answer: "네, 안양 하이퍼블릭 방문객의 약 40%가 1인 손님입니다. 가격 차이는 없으며, 오히려 1:1로 집중적인 케어를 받으실 수 있어 만족도가 높습니다. 어색하지 않게 담당 실장이 케어해 드립니다."
        },
        {
        ...
        },
        {
            ...
            answer: "주로 20대 초중반의 대학생, 모델 지망생들이 많습니다. 평촌역·범계역점은 영(Young)한 스타일, 평촌 신도시점은 고급스럽고 세련된 스타일 등 업소별 특색이 있으니 취향을 말씀해 주시면 맞춤 추천해 드립니다."
        },
        {
        ...
        },
        {
            ...
            answer: "안양 전 지역(평촌역·범계역, 평촌 신도시, 평촌동·범계동, 인덕원·만안구, 동안구, 청계동) 어디든 24시간 무료 픽업 차량을 보내드립니다. 예약 시 계신 곳 위치만 알려주세요."
        },
        {
            question: "복장 제한이 있나요?",
    ...
    return (
        <>
            <Helmet>
                <title>안양 하이퍼블릭 FAQ | 비용, 초이스, 혼술 등 자주 묻는 질문 10선</title>
                <meta name="description" content="안양 하이퍼블릭 이용 전 필독! 가격, 초이스 방식, 혼자 방문(독고), 2차 여부 등 고객님들이 가장 궁금해하시는 10가지 질문에 대해 서우실장이 솔직하게 답변해 드립니다." />
                <meta name="keywords" content="안양 하이퍼블릭 FAQ, 안양 하이퍼블릭 가격, 하이퍼블릭 혼자, 하이퍼블릭 초이스, 하이퍼블릭 2차" />
