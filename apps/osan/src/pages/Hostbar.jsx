    ...
    hostbar: [
        {
            ...
            desc: '오산역 인근 여성 전용 호빠. 프라이빗하게 즐기는 라운지.',
            features: ['여성 전용', '프라이빗 라운지', '오산역 접근', '안정적 분위기'],
            img: venueImg1,
            imgAlt: '오산 호빠 오산역 추천',
        },
        {
            ...
            location: '오산역 상권 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '오산역 상권 중심 감각적인 호빠. 감각적인 분위기와 포토존.',
            features: ['포토존', '감각적인 무드', '오산역 상권 중심', '트렌디'],
            img: venueImg2,
            imgAlt: '오산 호빠 오산역 상권 추천',
        }
    ]
};
...
const Hostbar = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "오산 호빠 예약 안내. 오산역 상권·삼성전자 오산캠퍼스 여성전용 라운지, 주대 18만원 이상/TC 10만원 이상.",
        "https://osankaraoke.com/osan-hostbar-guide",
        "180000"
    );
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    ...
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">오산 호빠(호스트바)는 오산역 상권·삼성전자 오산캠퍼스 중심 여성 고객 라운지로 운영됩니다.<br />프라이빗 코스와 맞춤 대화 중심으로 안내합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="definition" title="1. 오산 호빠 시스템">
                        <p>
                            오산 호스트바는 오직 여성 고객님들만을 위한 프라이빗 유흥 공간입니다.
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-rose-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 오산 호빠 추천 업소</h2>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-rose-800 to-pink-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오산에서 당신만을 위한 왕자님이 기다립니다</h2>
