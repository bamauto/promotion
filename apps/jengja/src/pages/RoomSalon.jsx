    ...
    roomSalon: [
        {
            ...
            desc: '정자역 인근 비즈니스 룸살롱. 정자·판교 테크 직장인 접대/회의에 맞춘 세팅.',
            features: ['비즈니스 세팅', '조용한 룸', '정자역 접근', '접대 중심'],
            img: '/venue-img-2.webp',
            imgAlt: '정자 룸살롱 정자역 추천',
        },
        {
            id: 'rs-2',
            name: '정자 룸살롱 - 레거시 클럽',
            ...
            location: '정자 카페거리 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '정자 카페거리 중심 하이엔드 룸살롱. 품격 있는 서비스와 프라이빗 룸.',
            features: ['하이엔드 서비스', '프라이빗 룸', '정자 카페거리 중심', '품격'],
            img: '/venue-img-9.webp',
            imgAlt: '정자 룸살롱 정자 카페거리 추천',
        }
    ]
};
...
const RoomSalon = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Jeongja Room Salon",
        "정자 룸살롱 예약 안내. 정자역·정자 카페거리 비즈니스 라인, 주대 18만원 이상/TC 10만원 이상.",
        "https://jengjakaraoke.com/jeongja-room-salon-guide",
        "200000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>정자 룸살롱 예약 | 정자역·정자 카페거리 비즈니스</title>
                <meta name="description" content="정자 룸살롱 프라이빗 가이드. 정자역·정자 카페거리 중심 비즈니스 접대, 조용한 룸. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta name="keywords" content="정자 룸살롱, 정자 룸살롱 예약, 정자 하이퍼블릭, 정자 가라오케" />
                <meta property="og:title" content="정자 룸살롱 예약 | 정자역·정자 카페거리 비즈니스" />
                <meta property="og:description" content="정자 룸살롱 프라이빗 가이드. 정자역·정자 카페거리 중심 비즈니스 접대, 조용한 룸. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="og:image" content="https://jengjakaraoke.com/og-room-salon.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="정자 룸살롱 예약 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="정자 룸살롱 예약 | 정자역·정자 카페거리 비즈니스" />
                <meta property="twitter:description" content="정자 룸살롱 프라이빗 가이드. 정자역·정자 카페거리 중심 비즈니스 접대, 조용한 룸. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="twitter:image" content="https://jengjakaraoke.com/og-room-salon.jpg" />
                <link rel="canonical" href="https://jengjakaraoke.com/jeongja-room-salon-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="효과적인 비즈니스 접대: 라운지 선택 가이드" subtitle="전략과 매너" /> (정자 상권 기준)

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">정자 룸살롱은 정자역·정자 카페거리 중심 비즈니스 라인에 맞춘 프라이빗 세팅입니다.<br />조용한 대화와 접대를 우선으로 원하는 스타일을 맞춰드립니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="definition" title="1. 정자 룸살롱이란? (Introduction)">
                        <p>
                            <strong>정통 룸살롱</strong>은 하이퍼블릭이나 가라오케보다 한 차원 높은 서비스와 수질을 제공하는 (정자 상권 기준)
                            <strong> 프라이빗 비즈니스 클럽</strong>입니다.
                        </p>
                        <p>
                            단순한 유흥을 넘어, 바이어 접대나 중요한 계약 성사 등을 위한 조용하고 품격 있는 분위기를 중시합니다. (정자 상권 기준)
                            철저한 회원제 운영과 예약제를 통해 외부 시선으로부터 자유로운 프라이빗 공간을 보장합니다. (정자 상권 기준)
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700 text-center">
                                <Crown className="mx-auto text-amber-500 mb-2" />
                                <div className="font-bold text-white">VVIP 접대 특화 (정자 상권 기준)</div>
                            </div>
                            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700 text-center">
                                <Shield className="mx-auto text-amber-500 mb-2" />
                                <div className="font-bold text-white">철저한 보안/프라이빗 (정자 상권 기준)</div>
                            </div>
                            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700 text-center">
                                <Star className="mx-auto text-amber-500 mb-2" />
                                <div className="font-bold text-white">최상위 매니저 (정자 상권 기준)</div>
                            </div>
                        </div>
                    </ContentBlock>
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-amber-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 추천 업소 (Recommendations) (정자 상권 기준)</h2>
                        </div>
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-amber-500" /> 정자 룸살롱 갤러리
                            </h3>
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    { src: '/partner/rs-gallery-01.webp', alt: '정자 룸살롱 VIP 매니저 - 정자역 비즈니스 접대' },
                                    { src: '/partner/rs-gallery-02.webp', alt: '정자 룸살롱 최고급 파트너 - 정자동 프리미엄 룸' },
                                    { src: '/partner/rs-gallery-03.webp', alt: '정자 룸살롱 프리미엄 서비스 - 정자동 정통' },
                                ].map((img, idx) => (
                    ...
                    {/* 3. System Guide */}
                    <ContentBlock id="system" title="3. 이용 시스템 및 특징 (정자 상권 기준)">
                        <p>
                            룸살롱은 일반 업소와는 차별화된 시스템으로 운영됩니다.
                        </p>

                        <h4 className="text-xl font-bold text-white mt-8 mb-4">A. 예약 및 입장 (정자 상권 기준)</h4>
                        <ul className="list-disc pl-5 space-y-2 marker:text-amber-500">
                            <li><strong>100% 예약제</strong>: 워킹 방문은 입장이 제한될 수 있습니다. 반드시 서우 실장을 통해 사전 예약해 주세요. (정자 상권 기준)</li>
                            <li><strong>맞춤형 세팅</strong>: 방문 목적(비즈니스, 회식, 개인 모임 등)을 미리 말씀해 주시면 그에 맞는 룸과 주류, 안주를 세팅해 드립니다. (정자 상권 기준)</li>
                        </ul>

                        <h4 className="text-xl font-bold text-white mt-8 mb-4">B. 초이스 및 서비스 (정자 상권 기준)</h4>
                        <ul className="list-disc pl-5 space-y-2 marker:text-amber-500">
                            <li><strong>정통 초이스</strong>: 마담의 인솔 하에 룸에서 직접 초이스가 이루어집니다. (정자 상권 기준)</li>
                            <li><strong>지명제 운영</strong>: 마음에 드는 매니저를 사전에 지명하여 예약하실 수 있습니다. (정자 상권 기준)</li>
                            <li><strong>애프터 케어</strong>: 비즈니스 성공을 위해 담당 매니저가 끝까지 최선을 다해 케어합니다. (정자 상권 기준)</li>
                        </ul>
                    </ContentBlock>
                    ...
                    <div id="faq" className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
                        <div className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800">
                            ...
                            <ul className="space-y-4 text-slate-300 font-light">
                                <li className="flex gap-3">
                                    ...
                                    <span><strong>사전 정보 공유</strong>: 접대하시는 손님의 취향(술, 스타일 등)을 미리 알려주시면 성공률 200%의 맞춤형 서비스를 준비합니다. (정자 상권 기준)</span>
                                </li>
                                <li className="flex gap-3">
                                    <CheckCircle className="text-amber-500 w-5 h-5 flex-shrink-0" />
                                    <span><strong>프라이빗 룸</strong>: 정자 카페거리 미팅은 방음 좋은 룸으로 우선 안내합니다.</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-amber-900/10 p-8 rounded-2xl border border-amber-500/20">
                            ...
                            <div className="mt-6 text-center">
                                <Link to="/jeongja-room-salon-guide/faq" className="inline-flex items-center gap-2 text-amber-500 hover:text-amber-400 font-bold transition-colors">
                    ...
                    <div className="bg-gradient-to-r from-amber-600 to-amber-700 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">정자에서 귀하의 품격에 어울리는 곳</h2>
                        <p className="text-amber-100 mb-8 max-w-2xl mx-auto relative z-10">
                            중요한 자리일수록 전문가에게 맡기셔야 합니다.<br />
                            정자 정통 룸살롱 예약 1위, 서우실장이 책임지겠습니다.
                        </p>
