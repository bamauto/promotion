...
const routeNameMap = {
    'gwanggyo-highpub-guide': '하이퍼블릭',
    'gwanggyo-karaoke-guide': '가라오케',
    'gwanggyo-shirtsroom-guide': '셔츠룸',
    'gwanggyo-kimono-room-guide': '기모노룸',
    'gwanggyo-room-salon-guide': '룸살롱',
    'gwanggyo-hostbar-guide': '호빠',
    'gwanggyo-entertainment-price-guide': '가격 가이드',
    'gwanggyo-entertainment-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    const schemaItems = [
        {
            ...
            "position": 1,
            "name": "Home",
            "item": "https://gwanggyokaraoke.com/"
        }
    ];
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://gwanggyokaraoke.com${routeTo}`
        });
    });
