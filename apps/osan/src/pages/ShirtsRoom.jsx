    ...
    shirtsRoom: [
        {
            ...
            desc: '오산역 인근 클래식 셔츠룸. 깔끔한 응대와 흐트러짐 없는 동선.',
            features: ['클래식 무드', '빠른 세팅', '오산역 접근', '기본에 충실'],
            img: venueImg1,
            imgAlt: '오산 셔츠룸 오산역 추천',
        },
        {
            id: 's-2',
            name: '오산구 모델 셔츠룸',
            ...
            location: '오산역 상권 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '오산역 상권 중심 모던 셔츠룸. 감각적인 인테리어와 빠른 초이스.',
            features: ['모던 인테리어', '초이스 중심', '오산역 상권 중심', '경쾌한 분위기'],
            img: venueImg2,
            imgAlt: '오산 셔츠룸 오산역 상권 추천',
        }
    ]
};
...
const ShirtsRoom = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Shirts Room Club",
        "오산 셔츠룸 예약 안내. 오산역 상권·오산대역 중심, 주대 18만원 이상/TC 10만원 이상.",
        "https://osankaraoke.com/osan-shirtsroom-guide",
        "180000"
    );
        ...
        <>
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="오산 셔츠룸 시스템 가이드" subtitle="White Shirt Fantasy" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">오산 셔츠룸은 오산역 상권·오산대역 중심 라인업으로 구성됩니다.<br />감각적인 분위기와 빠른 초이스를 선호하시는 분께 적합합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>
                    ...
                    <ContentBlock id="definition" title="1. 셔츠룸이란?">
                        ...
                        <p>
                            오산 셔츠룸은 강남의 '란제리', '레깅스' 룸보다 진입 장벽이 낮으면서도, 퍼블릭보다 훨씬 과감하고 화끈한 노는 분위기를 형성합니다.
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-blue-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 오산 셔츠룸 추천 업소</h2>
                        </div>
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-blue-500" /> 오산 셔츠룸 갤러리
                            </h3>
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    { src: '/partner/sr-gallery-01.webp', alt: '오산 셔츠룸 프리미엄 매니저 - 오산역 VIP 서비스' },
                                    { src: '/partner/sr-gallery-02.webp', alt: '오산 셔츠룸 최고급 파트너 - 오산구 럭셔리 룸' },
                                    { src: '/partner/sr-gallery-03.webp', alt: '오산 셔츠룸 VIP 매니저 - 오산구 프리미엄' },
                                ].map((img, idx) => (
                    ...
                    <div className="bg-gradient-to-r from-blue-800 to-cyan-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오산 비즈니스의 확실한 파트너</h2>
