...
const services = [
    ...
    },
    {
        ...
        name: '기모노룸',
        desc: '이색적인 코스튬 테마',
        path: '/dongtan-kimono-room-guide',
        icon: Flower2,
        color: 'text-pink-400'
    },
    {
        ...
        <section className="py-20 bg-slate-900 border-t border-slate-800">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-slate-400">동탄 최고의 밤문화 코스를 확인해보세요.</p>
                </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-bold text-white group-hover:text-amber-400 transition-colors">동탄 {service.name}</h4>
