...
const PriceGuide = () => {
    return (
        <>
            <Helmet>
                <title>정자 유흥 가격비교 2026 | 하이퍼블릭·룸살롱·가라오케 주대표</title>
                <meta name="description" content="정자 유흥업소 가격 완전 정복 | 하이퍼블릭 18만원~ | 셔츠룸·룸살롱·가라오케 주대 비교 | 100% 정찰제 가격표 공개 | 바가지 ZERO | ☎ 010-2626-4833" />
                <meta name="keywords" content="정자 유흥 가격, 정자 룸살롱 가격, 하이퍼블릭 주대, 가라오케 비용, 셔츠룸 시스템 가격, 정자 TC 가격" />
                <meta property="og:title" content="정자 유흥 가격비교 2026 | 정찰제 가격표 공개" />
                <meta property="og:description" content="하이퍼블릭·룸살롱·가라오케 주대 비교 | 바가지 ZERO | 100% 정찰제" />
                <meta property="og:image" content="https://www.jengjakaraoke.com/og-price.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="정자 유흥 가격 비교표" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="정자 유흥 가격비교 | 정찰제 가격표" />
                <meta property="twitter:description" content="하이퍼블릭·룸살롱·가라오케 주대 비교 | 바가지 ZERO" />
                <meta property="twitter:image" content="https://www.jengjakaraoke.com/og-price.jpg" />
                <link rel="canonical" href="https://www.jengjakaraoke.com/jeongja-entertainment-price-guide" />
            </Helmet>
                                ...
                                <tbody className="text-slate-300 divide-y divide-slate-800">
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        <td className="py-4 px-6 font-bold text-amber-400">
                                            <Link to="/jeongja-highpub-guide" className="hover:underline">하이퍼블릭</Link>
                                        </td>
                                    ...
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        <td className="py-4 px-6 font-bold text-blue-400">
                                            <Link to="/jeongja-shirtsroom-guide" className="hover:underline">셔츠룸</Link>
                                        </td>
                                    ...
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        <td className="py-4 px-6 font-bold text-purple-400">
                                            <Link to="/jeongja-karaoke-guide" className="hover:underline">가라오케</Link>
                                        </td>
                                    ...
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        <td className="py-4 px-6 font-bold text-amber-600">
                                            <Link to="/jeongja-room-salon-guide" className="hover:underline">정통 룸살롱</Link>
                                        </td>
                                    ...
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        <td className="py-4 px-6 font-bold text-rose-500">
                                            <Link to="/jeongja-hostbar-guide" className="hover:underline">호스트바 (호빠)</Link>
                                        </td>
                                        <td className="py-4 px-6">18만원~</td>
