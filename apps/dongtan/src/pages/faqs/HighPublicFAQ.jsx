...
const HighPublicFAQ = () => {
    const faqList = [
    {
        question: "동탄 하이퍼블릭과 퍼블릭의 차이는 무엇인가요?",
        answer: "하이퍼블릭은 퍼블릭 대비 인테리어와 서비스 퀄리티를 높인 타입입니다. 동탄 신도시 직장인 이용이 많아 조용한 대화와 프라이빗 동선에 초점을 둡니다."
    },
    {
        question: "혼자 방문해도 괜찮나요?",
        answer: "네, 1인 방문도 환영합니다. 동탄 상권 특성상 1:1 요청이 많아 모던한 톤으로 안내드립니다."
    },
    {
        question: "픽업은 어디까지 가능한가요?",
        answer: "픽업은 동탄역, 동탄호수공원, 동탄센트럴파크, 반송동 상권 중심으로 운영됩니다. 예약 시 동선을 맞춰드립니다."
    },
    {
        question: "주대와 TC 기준이 궁금합니다.",
        answer: "주대 18만원 이상, TC 10만원 이상 기준이며 시간·코스·인원에 따라 달라질 수 있습니다. 상세는 문의 바랍니다. (동탄 상권 기준)"
    },
    {
        question: "예약은 꼭 필요한가요?",
        answer: "피크 타임에는 대기 가능성이 있어 예약을 권장합니다. 사전 예약 시 동선과 룸 타입을 미리 맞춰드립니다. (동탄 상권 기준)"
    },
    {
        question: "복장 제한이 있나요?",
        answer: "강제 드레스 코드는 없지만 깔끔한 캐주얼을 추천합니다. 비즈니스 목적이라면 포멀한 복장이 좋습니다. (동탄 상권 기준)"
    }
];
    ...
    return (
        <>
            <Helmet>
                <title>동탄 하이퍼블릭 FAQ | 가격·픽업·예약 안내</title>
                <meta name="description" content="동탄 하이퍼블릭 이용 전 필독 FAQ. 주대/TC 기준, 픽업 범위, 예약 팁을 정리했습니다." />
                <meta name="keywords" content="동탄 하이퍼블릭 FAQ, 동탄 하이퍼블릭 가격, 동탄 하이퍼블릭 예약" />
                <link rel="canonical" href="https://dongtankaraoke.net/dongtan-highpub-guide/faq" />
            </Helmet>
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950 px-4 pb-20">
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="mt-16 text-center">
                        <p className="text-slate-400 mb-6">더 궁금한 점이 있으신가요? 24시간 언제든 물어보세요. (동탄 상권 기준)</p>
                        <div className="flex flex-col md:flex-row justify-center gap-4">
                            ...
                            <Link to="/dongtan-highpub-guide" className="bg-slate-800 hover:bg-slate-700 text-white font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-2 transition-all">
                                <ChevronRight size={20} /> 동탄 하이퍼블릭 메인으로
                            </Link>
                        </div>
                    </div>
                </div>
