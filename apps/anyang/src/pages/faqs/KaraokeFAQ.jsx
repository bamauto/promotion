...
const KaraokeFAQ = () => {
    const faqList = [
        ...
        },
        {
            ...
            answer: "안양 가라오케는 1종 유흥업소가 아닌 곳도 있어 업소마다 다릅니다. 하지만 서우실장이 안내하는 제휴 업소들은 정식 허가를 받아 합법적으로 매니저(TC) 호출이 가능합니다. 퍼블릭급 수질의 매니저들을 초이스하실 수 있습니다."
        },
        {
    ...
    return (
        <>
            <Helmet>
                <title>안양 가라오케 이용 팁 & FAQ | 가격, 파티, 여성 이용 안내</title>
                <meta name="description" content="안양 가라오케 이용에 대한 모든 궁금증 해결! 가격, 안주, 생일 파티 혜택, 여성 고객 우대, 혼술 가능 여부까지 상세하게 안내해 드립니다." />
                <meta name="keywords" content="안양 가라오케 가격, 안양 가라오케 파티, 안양 가라오케 혼술, 안양 가라오케 여성전용" />
