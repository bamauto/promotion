    ...
    roomSalon: [
        {
            ...
            desc: '오산역 인근 비즈니스 룸살롱. 오산·오산/평택 테크 직장인 접대/회의에 맞춘 세팅.',
            features: ['비즈니스 세팅', '조용한 룸', '오산역 접근', '접대 중심'],
            img: '/venue-img-2.webp',
            imgAlt: '오산 룸살롱 오산역 추천',
        },
        {
            id: 'rs-2',
            name: '오산 룸살롱 - 레거시 클럽',
            ...
            location: '오산역 상권 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '오산역 상권 중심 하이엔드 룸살롱. 품격 있는 서비스와 프라이빗 룸.',
            features: ['하이엔드 서비스', '프라이빗 룸', '오산역 상권 중심', '품격'],
            img: '/venue-img-9.webp',
            imgAlt: '오산 룸살롱 오산역 상권 추천',
        }
    ]
};
...
const RoomSalon = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Jeongja Room Salon",
        "오산 룸살롱 예약 안내. 오산역·오산역 상권 비즈니스 라인, 주대 18만원 이상/TC 10만원 이상.",
        "https://osankaraoke.com/osan-room-salon-guide",
        "200000"
    );
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image:alt" content="오산 룸살롱 예약 가이드" />
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    ...
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">오산 룸살롱은 오산역·오산역 상권 중심 비즈니스 라인에 맞춘 프라이빗 세팅입니다.<br />조용한 대화와 접대를 우선으로 원하는 스타일을 맞춰드립니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="definition" title="1. 오산 룸살롱이란? (Introduction)">
                        <p>
                    ...
                    <div id="recommendation" className="mb-24">
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-amber-500" /> 오산 룸살롱 갤러리
                            </h3>
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    { src: '/partner/rs-gallery-01.webp', alt: '오산 룸살롱 VIP 매니저 - 오산역 비즈니스 접대' },
                                    { src: '/partner/rs-gallery-02.webp', alt: '오산 룸살롱 최고급 파트너 - 오산구 프리미엄 룸' },
                                    { src: '/partner/rs-gallery-03.webp', alt: '오산 룸살롱 프리미엄 서비스 - 오산구 정통' },
                                ].map((img, idx) => (
                    ...
                    <div id="faq" className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
                        <div className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800">
                            ...
                            <ul className="space-y-4 text-slate-300 font-light">
                                ...
                                <li className="flex gap-3">
                                    <CheckCircle className="text-amber-500 w-5 h-5 flex-shrink-0" />
                                    <span><strong>프라이빗 룸</strong>: 오산역 상권 미팅은 방음 좋은 룸으로 우선 안내합니다.</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-amber-900/10 p-8 rounded-2xl border border-amber-500/20">
                            ...
                            <div className="mt-6 text-center">
                                <Link to="/osan-room-salon-guide/faq" className="inline-flex items-center gap-2 text-amber-500 hover:text-amber-400 font-bold transition-colors">
                    ...
                    <div className="bg-gradient-to-r from-amber-600 to-amber-700 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오산에서 귀하의 품격에 어울리는 곳</h2>
                        <p className="text-amber-100 mb-8 max-w-2xl mx-auto relative z-10">
                            중요한 자리일수록 전문가에게 맡기셔야 합니다.<br />
                            오산 정통 룸살롱 예약 1위, 서우실장이 책임지겠습니다.
                        </p>
