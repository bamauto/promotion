...
const venues = {
    karaoke: [
        ...
        },
        {
            ...
            location: '판교역 인근',
            price: '주대 18만원 이상 · TC 10만원 이상 (상세 문의)',
            desc: '서현·판교 라인에서 입소문 난 시크릿 벙커 컨셉. 외부 간판 없이 운영되며, 조용한 보안 동선으로 프라이버시를 지켜드립니다.',
        ...
        },
        {
            ...
            location: '분당 수내역',
            price: '주대 18만원 이상 · TC 10만원 이상 (상세 문의)',
            desc: '판교테크노밸리 미팅 후 이어지는 비즈니스 모임에 맞춘 라인. 조용한 진행과 세심한 케어로 접대 완성도를 높여드립니다.',
                    ...
                    <div id="recommendation" className="mb-24">
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-purple-500" /> 분당 가라오케 갤러리
                            </h3>
