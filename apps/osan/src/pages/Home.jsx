    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image:alt" content="오산 하이퍼블릭·가라오케 메인 가이드" />
                ...
                <div className="relative z-10 container mx-auto px-4 text-center mt-10">
                    <div className="animate-fade-in-up">
                        <span className="inline-flex items-center gap-2 border border-amber-500/30 bg-amber-900/10 backdrop-blur-md text-amber-400 px-6 py-2 rounded-full text-xs font-bold tracking-[0.2em] mb-8 uppercase hover:bg-amber-900/20 transition-colors cursor-default">
                            <Crown size={12} fill="currentColor" /> 오산 유흥 컨설팅 전문
                        </span>
            ...
            <section id="features" className="py-24 bg-slate-950 container mx-auto px-4 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <FeatureItem icon={Car} title="편리한 이동 지원" desc="오산 전 지역 이동 편의를 위한 픽업 서비스를 운영합니다." delay={300} />
                </div>
            </section>
            ...
            <section className="py-24 bg-slate-950 overflow-hidden">
                ...
                <div className="relative flex overflow-hidden">
                    <div className="flex animate-infinite-scroll whitespace-nowrap group hover:[animation-play-state:paused]">
                        ...
                        {[
                            { src: '/partner/partner-01.webp', alt: '오산 가라오케 프리미엄 매니저 - 서우실장 엄선 파트너' },
                            { src: '/partner/partner-02.webp', alt: '오산 하이퍼블릭 최고급 매니저 - 오산구 서우실장 추천' },
                            { src: '/partner/partner-03.webp', alt: '오산 가라오케 VIP 매니저 - 오산역 프리미엄' },
                            { src: '/partner/partner-04.webp', alt: '오산 하이퍼블릭 프리미엄 파트너 - 오산역 서우실장' },
                            { src: '/partner/partner-05.webp', alt: '오산 셔츠룸 인기 매니저 - 서우실장 베스트 초이스' },
                            { src: '/partner/partner-06.webp', alt: '오산 하이퍼블릭 엄선 매니저 - 오산 서우실장' },
                            { src: '/partner/partner-07.webp', alt: '오산 가라오케 TOP 매니저 - 오산구 서우실장 추천' },
                            { src: '/partner/partner-01.webp', alt: '오산 가라오케 프리미엄 매니저 - 서우실장 엄선 파트너' },
                            { src: '/partner/partner-02.webp', alt: '오산 하이퍼블릭 최고급 매니저 - 오산구 서우실장 추천' },
                            { src: '/partner/partner-03.webp', alt: '오산 가라오케 VIP 매니저 - 오산구 라운지' },
                            { src: '/partner/partner-04.webp', alt: '오산 하이퍼블릭 프리미엄 파트너 - 오산역 서우실장' },
                            { src: '/partner/partner-05.webp', alt: '오산 셔츠룸 인기 매니저 - 서우실장 베스트 초이스' },
                            { src: '/partner/partner-06.webp', alt: '오산 하이퍼블릭 엄선 매니저 - 오산 서우실장' },
                            { src: '/partner/partner-07.webp', alt: '오산 가라오케 TOP 매니저 - 오산구 서우실장 추천' },
            ...
            <section className="py-24 container mx-auto px-4">
                <SectionTitle title="제휴 업소 안내" subtitle="오산 유흥 핫플레이스" />
