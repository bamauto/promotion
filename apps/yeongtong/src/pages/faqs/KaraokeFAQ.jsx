...
const KaraokeFAQ = () => {
    const faqList = [
    {
        question: "영통 가라오케는 어떤 흐름으로 이용하나요?",
        answer: "예약 후 룸 배정 → 기본 세팅 → 노래 및 파티 진행 순으로 안내됩니다. (영통 상권 기준)"
    },
    {
        question: "단체나 회식도 가능한가요?",
        answer: "가능합니다. 삼성디지털시티 직장인 회식 수요가 많아 단체 룸도 준비되어 있습니다."
    },
    {
        question: "픽업 가능 지역은 어디인가요?",
        answer: "영통역, 망포역, 삼성디지털시티, 매탄동 상권 주변 중심으로 운영됩니다."
    },
    {
        question: "주대/TC 기준이 어떻게 되나요?",
        answer: "주대 18만원 이상, TC 10만원 이상 기준이며 상세는 상담 시 안내드립니다. (영통 상권 기준)"
    },
    {
        question: "예약 없이 방문해도 되나요?",
        answer: "가능은 하지만 영통 상권 기준은 대기 발생 가능성이 있어 예약을 추천드립니다."
    },
    {
        question: "기기나 음향 퀄리티는 어떤가요?",
        answer: "최신 음향과 대형 스크린을 기준으로 관리하며, 룸별로 세팅이 다를 수 있습니다. (영통 상권 기준)"
    }
];
    ...
    return (
        <>
            <Helmet>
                <title>영통 가라오케 FAQ | 예약·픽업·이용 안내</title>
                <meta name="description" content="영통 가라오케 이용 FAQ. 단체/회식, 픽업 범위, 예약 흐름을 안내합니다." />
                <meta name="keywords" content="영통 가라오케 FAQ, 영통 가라오케 예약, 영통 가라오케 가격" />
                <link rel="canonical" href="https://yeongtongkaraoke.com/yeongtong-karaoke-guide/faq" />
            </Helmet>
                ...
                <div className="container mx-auto max-w-4xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400 text-lg leading-relaxed max-w-2xl mx-auto">
                            노래, 술, 파티가 있는 곳. <strong className="text-white">영통 가라오케</strong>를 200% 즐기는 방법을 알려드립니다.
                        </p>
                    </div>
                    ...
                    <div className="mt-16 text-center">
                        <div className="flex flex-col md:flex-row justify-center gap-4">
                            ...
                            <Link to="/yeongtong-karaoke-guide" className="bg-slate-800 hover:bg-slate-700 text-white font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-2 transition-all">
