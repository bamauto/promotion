...
const HyperPublicFAQ = () => {
    const faqList = [
    {
        question: "평택 하이퍼블릭과 퍼블릭의 차이는 무엇인가요?",
        answer: "하이퍼블릭은 퍼블릭 대비 인테리어와 서비스 퀄리티를 높인 타입입니다. 평택·평택 테크 직장인 이용이 많아 조용한 대화와 프라이빗 동선에 초점을 둡니다."
    },
    {
        question: "혼자 방문해도 괜찮나요?",
        answer: "네, 1인 방문도 환영합니다. 평택 상권 특성상 1:1 요청이 많아 감각적인하게 안내드립니다."
    },
    {
        question: "픽업은 어디까지 가능한가요?",
        answer: "픽업은 평택역, 평택역 상권, 평택 산업단지, 구성역 중심으로 운영됩니다. 예약 시 동선을 맞춰드립니다."
    },
    {
