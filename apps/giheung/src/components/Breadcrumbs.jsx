...
const routeNameMap = {
    'giheung-highpub-guide': '하이퍼블릭',
    'giheung-karaoke-guide': '가라오케',
    'giheung-shirtsroom-guide': '셔츠룸',
    'giheung-kimono-room-guide': '기모노룸',
    'giheung-room-salon-guide': '룸살롱',
    'giheung-hostbar-guide': '호빠',
    'giheung-entertainment-price-guide': '가격 가이드',
    'giheung-entertainment-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://giheungkaraoke.com${routeTo}`
        });
    });
