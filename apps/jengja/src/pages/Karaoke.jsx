    ...
    karaoke: [
        {
            ...
            location: '정자 분당역 5번 출구',
            price: '기본가 180,000원 ~',
            desc: '분당역의 랜드마크. 최대 30명 수용 가능한 대형 파티룸을 완비하여 피로연이나 동호회 모임에 제격입니다. 최신 사이키 조명과 클럽 사운드 시스템으로 열광적인 분위기를 연출합니다.',
            features: ['30인 대형룸', '클럽 조명', 'DJ 섭외 가능', '24시간 운영'],
            img: venueImg1,
            imgAlt: '정자 프리미엄 가라오케 인테리어'
        },
        {
            id: 'k-2',
            name: '정자동 럭셔리 가라오케',
            type: 'Luxury Lounge',
            location: '정자 정자동 카페거리',
            price: '기본가 200,000원 ~',
...
const Karaoke = () => {
    const faqList = [
        {
            question: "정자 가라오케의 음향 시설 수준은 어느 정도인가요?",
    ...
    const serviceSchema = generateServiceSchema(
        "Karaoke",
        "정자 가라오케 추천 및 가격표. 최신 음향 시설과 대형 룸 완비.",
        "https://www.jengjakaraoke.com/jeongja-karaoke-guide",
        "100000"
    );
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image" content="https://www.jengjakaraoke.com/og-karaoke.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="정자 가라오케 장소 선택 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="정자 가라오케 선택 가이드" />
                <meta property="twitter:description" content="용도별·분위기별 추천 | 음향 비교 | 에티켓 안내" />
                <meta property="twitter:image" content="https://www.jengjakaraoke.com/og-karaoke.jpg" />
                <link rel="canonical" href="https://www.jengjakaraoke.com/jeongja-karaoke-guide" />
            </Helmet>
                        ...
                        <div className="mt-16">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    ...
                                    { src: '/partner/kr-gallery-03.webp', alt: '정자 가라오케 VIP 매니저 - 분당구 프리미엄' },
