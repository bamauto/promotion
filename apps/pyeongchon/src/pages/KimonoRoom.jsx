    ...
    kimonoRoom: [
        {
            ...
            img: '/partner/km-gallery-01.webp',
        ...
        },
        {
            ...
            img: '/partner/km-gallery-02.webp',
            imgAlt: '평촌 기모노룸 평촌역 추천',
        }
    ]
};
...
const KimonoRoom = () => {
    const faqList = [
    {
        question: "평촌에 정통 기모노룸이 정말 있나요?",
        answer: "예, 평촌 유일 정통 기모노 테마 룸입니다. 일본 현지 유카타와 기모노를 직접 수입하여 정통 분위기를 재현했습니다. 사케 소믈리에 서비스까지 제공합니다."
    },
    {
        question: "일본 바이어 접대에 적합한가요?",
        answer: "인덕원 IT단지·과학단지 일본 바이어 접대에 최적화되어 있습니다. 일본어 가능 매니저 배정이 가능하며, 전통 의전 서비스로 접대 성공률이 매우 높습니다."
    },
    {
        question: "기모노 스타일링 시간이 얼마나 걸리나요?",
        answer: "기모노 환복에 15~20분이 소요되어 최소 2시간 전 예약이 필수입니다. 스타일링 비용은 TC에 포함되어 있으니 별도 비용 걱정 없으셔도 됩니다."
    },
    {
        question: "평촌 신도시 VIP들이 기모노룸 선호하는 이유가 뭔가요?",
        answer: "1기 신도시 고소득층의 '남다른 취향'을 만족시키는 히든 플레이스입니다. 강남에서도 찾기 어려운 정통 기모노 체험을 평촌에서 프라이빗하게 즐기실 수 있습니다."
    }
];
    ...
    const serviceSchema = generateServiceSchema(
        "Kimono Room",
        "평촌 기모노룸 예약 안내. 범계역·인덕원역 테마, 주대 18만원 이상/TC 10만원 이상.",
        "https://pc-karaoke.com/pyeongchon-kimono-room-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>평촌 기모노룸 예약 | 범계역·인덕원역 테마</title>
                <meta name="description" content="평촌 기모노룸 테마 가이드. 범계역·인덕원역 중심 이색 무드와 포토 포인트. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta name="keywords" content="평촌 기모노룸, 평촌 기모노룸 예약, 평촌 룸살롱, 평촌 하이퍼블릭" />
                <meta property="og:title" content="평촌 기모노룸 예약 | 범계역·인덕원역 테마" />
                <meta property="og:description" content="평촌 기모노룸 테마 가이드. 범계역·인덕원역 중심 이색 무드와 포토 포인트. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="og:image" content="https://pc-karaoke.com/og-kimono-room.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="평촌 기모노룸 예약 | 범계역·인덕원역 테마" />
                <meta property="twitter:description" content="평촌 기모노룸 테마 가이드. 범계역·인덕원역 중심 이색 무드와 포토 포인트. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="twitter:image" content="https://pc-karaoke.com/og-kimono-room.jpg" />
                <link rel="canonical" href="https://pc-karaoke.com/pyeongchon-kimono-room-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="평촌 기모노룸 가이드" subtitle="Exotic Atmosphere" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">평촌 기모노룸은 범계역·인덕원역 테마 중심으로 이색 무드를 제공합니다.<br />포토 포인트와 테마 연출을 함께 즐기실 수 있습니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="definition" title="1. 평촌 유일 정통 기모노 체험">
                        <p>
                            <strong className="text-rose-400">평촌 유일</strong> 정통 기모노 테마 룸살롱입니다.
                        ...
                        <p>
                            ...
                            1기 신도시 고소득층의 "남다른 취향"을 만족시키는 평촌의 히든 플레이스로, 예약 시 최소 2시간 전 연락 필수.
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                            <div className="bg-slate-800 p-4 rounded-xl border border-slate-700 flex items-center justify-center gap-3">
                                <span className="text-rose-500 font-bold text-lg">평촌 유일</span>
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h2 className="text-3xl font-bold text-white">2. 평촌 기모노룸 추천 목록</h2>
                        </div>
                    ...
                    <div className="mt-16">
                        <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                            <Sparkles className="text-rose-500" /> 평촌 기모노룸 갤러리
                        </h3>
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                            {[
                                { src: '/partner/km-gallery-01.webp', alt: '평촌 기모노룸 전통 의상 매니저 - 평촌역·범계역 테마룸' },
                                { src: '/partner/km-gallery-02.webp', alt: '평촌 기모노룸 프리미엄 서비스 - 평촌학원가 유카타 컨셉' },
                                { src: '/partner/km-gallery-03.webp', alt: '평촌 기모노룸 VIP 파트너 - 평촌 신도시 이색 체험' },
                                { src: '/partner/km-gallery-04.webp', alt: '평촌 기모노룸 최고급 매니저 - 화성시 일본풍 테마' },
                                { src: '/partner/km-gallery-05.webp', alt: '평촌 기모노룸 럭셔리 서비스 - 평촌 프리미엄' },
                            ].map((img, idx) => (
                                <div key={idx} className="aspect-[3/4] rounded-2xl overflow-hidden border border-slate-800 hover:border-rose-500/50 transition-all duration-300 group">
                                    <img src={img.src} alt={img.alt} title="평촌 기모노룸 프리미엄 매니저" loading="lazy" width="300" height="400"
                    ...
                    <div className="bg-gradient-to-r from-red-800 to-orange-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">평촌에서 지루한 일상에 색다른 파격을</h2>
                        <p className="text-red-100 mb-8 max-w-2xl mx-auto relative z-10">
                            경험해보지 못한 새로운 즐거움.<br />
                            평촌 기모노룸에서 잊지 못할 추억을 만들어 드립니다.
                        </p>
