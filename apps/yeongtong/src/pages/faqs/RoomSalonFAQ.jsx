...
const RoomSalonFAQ = () => {
    const faqList = [
        ...
        {
            question: "강남 룸살롱과 정자의 차이는 무엇인가요?",
            answer: "퀄리티 면에서는 강남 텐카페/쩜오에 뒤지지 않으면서, 가격 거품은 뺀 것이 정자의 장점입니다. 강남 대비 약 70~80% 수준의 비용으로 동급의 서비스를 즐기실 수 있어 실속파 사장님들이 많이 넘어오십니다."
        },
        {
    ...
    return (
        <>
            <Helmet>
                <title>영통 룸살롱 비즈니스 접대 FAQ | 법인 결제, 지명 예약, 견적 문의</title>
                <meta name="description" content="성공적인 비즈니스 접대를 위한 영통 룸살롱 이용 가이드. 법인 비용 처리, 외국어 가능 매니저, 프라이빗 보안 시스템 등 접대 담당자가 가장 궁금해하는 10가지 질문에 답해드립니다." />
                <meta name="keywords" content="영통 룸살롱 접대, 영통 룸살롱 법인카드, 영통 룸살롱 가격, 강남 영통 룸살롱 비교" />
