...
const routeNameMap = {
    'osan-highpub-guide': '하이퍼블릭',
    'osan-karaoke-guide': '가라오케',
    'osan-shirtsroom-guide': '셔츠룸',
    'osan-kimono-room-guide': '기모노룸',
    'osan-room-salon-guide': '룸살롱',
    'osan-hostbar-guide': '호빠',
    'osan-entertainment-price-guide': '가격 가이드',
    'osan-entertainment-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://osankaraoke.com${routeTo}`
        });
    });
