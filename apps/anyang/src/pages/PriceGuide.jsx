...
const PriceGuide = () => {
    return (
        <>
            <Helmet>
                <title>안양 유흥 가격 가이드 | 주대 18만원 이상 기준</title>
                <meta name="description" content="안양 유흥 가격 가이드. 하이퍼블릭·가라오케·룸살롱·셔츠룸 기준을 정리했습니다. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta name="keywords" content="안양 유흥 가격, 안양 주대, 안양 TC, 안양 하이퍼블릭 가격" />
                <meta property="og:title" content="안양 유흥 가격 가이드 | 주대 18만원 이상 기준" />
                <meta property="og:description" content="안양 유흥 가격 가이드. 하이퍼블릭·가라오케·룸살롱·셔츠룸 기준을 정리했습니다. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="og:image" content="https://anyangkaraoke.com/og-price.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="안양 유흥 가격 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="안양 유흥 가격 가이드 | 주대 18만원 이상 기준" />
                <meta property="twitter:description" content="안양 유흥 가격 가이드. 하이퍼블릭·가라오케·룸살롱·셔츠룸 기준을 정리했습니다. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950 px-4 pb-20">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400 text-lg leading-relaxed max-w-3xl mx-auto">안양 상권 기준 주대/TC 기준을 한눈에 정리했습니다.<br />범계역·평촌역 중심 업소 기준으로 안내하며 상세 견적은 문의 부탁드립니다.</p>
                    </div>
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="text-slate-300 divide-y divide-slate-800">
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        ...
                                        <td className="py-4 px-6">주대 18만원 이상 (안양 상권 기준)</td>
                                        <td className="py-4 px-6">TC 10만원 이상 (안양 상권 기준)</td>
                                    ...
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        ...
                                        <td className="py-4 px-6">주대 18만원 이상 (안양 상권 기준)</td>
                                        <td className="py-4 px-6">TC 10만원 이상 (안양 상권 기준)</td>
                                        <td className="py-4 px-6 text-sm">안양역·안양1번가 주변 여성 고객 맞춤 라운지.</td>
                                    </tr>
</tbody>
                            </table>
                        </div>
                        <div className="p-3 bg-slate-800/50 text-xs text-slate-400 text-center">
                            📊 안양 주요 상권 기준 안내 | 범계역·평촌역 중심 가이드
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-900/50 rounded-2xl border border-slate-800 overflow-hidden mb-16 shadow-xl">
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-slate-800 text-white">
                                        <th className="py-4 px-6 font-bold text-lg md:w-1/4">구분 (안양 상권 기준)</th>
                                        <th className="py-4 px-6 font-bold text-lg md:w-1/4">기본 주대 (SET) (안양 상권 기준)</th>
                                        <th className="py-4 px-6 font-bold text-lg md:w-1/4">매니저 봉사료 (T/C) (안양 상권 기준)</th>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                        <div className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800">
                            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                                <DollarSign className="text-green-500" /> 계산서 보는 법 (안양 상권 기준)
                            </h2>
                            <ul className="space-y-4 text-slate-300">
                                <li className="flex gap-3">
                                    <CheckCircle className="text-green-500 flex-shrink-0 mt-1" size={20} />
                                    <div>
                                        <strong className="text-white block mb-1">기본 주대 (Liquor Price) (안양 상권 기준)</strong>
                                        안양 기준 안내는 기본 주류 1병과 과일/안주 포함 구성이며, 추가 주문은 별도입니다.
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <CheckCircle className="text-green-500 flex-shrink-0 mt-1" size={20} />
                                    <div>
                                        ...
                                        매니저(아가씨/선수)의 봉사료입니다. 보통 시간 단위(60분~90분)로 계산되거나, 묶음(통)으로 계산됩니다. (안양 상권 기준)
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <CheckCircle className="text-green-500 flex-shrink-0 mt-1" size={20} />
                                    <div>
                                        ...
                                        룸 서빙을 담당하는 웨이터의 봉사료입니다. 보통 룸당 별도 안내됩니다. (안양 상권 기준)
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-amber-900/10 p-8 rounded-2xl border border-amber-500/20">
                            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                                <AlertTriangle className="text-amber-500" /> 바가지요금 주의보 (안양 상권 기준)
                            </h2>
                            <p className="text-slate-300 mb-4 leading-relaxed">안양 상권에서도 일부 비양심적인 영업진들이 손님이 술에 취한 틈을 타 <strong>'술병 늘리기'</strong>를 하거나, 계산서에 안 먹은 안주를 몰래 넣는 경우가 있습니다.</p>
                            ...
                            <div className="bg-slate-950 p-4 rounded-xl border border-amber-500/30 text-amber-200 text-sm font-bold text-center">
                                "저렴하다고 무조건 좋은 게 아닙니다. 믿을 수 있는 사람을 찾으세요. (안양 기준)"
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-white mb-6">내 예산에 딱 맞는 곳이 궁금하다면? (안양 상권 기준)</h2>
                        <button onClick={() => window.location.href = 'tel:01026264833'} className="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-12 rounded-full shadow-lg hover:scale-105 transition-transform flex items-center gap-2 mx-auto">
                            <Phone fill="currentColor" size={20} /> 30초 만에 견적 받기 (안양 상권 기준)
                        </button>
                    </div>
