            ...
            <header className={`fixed top-0 w-full z-50 transition-all duration-300 border-b ${scrolled ? 'bg-slate-950/90 backdrop-blur-xl border-slate-800 py-2' : 'bg-transparent border-transparent py-4'}`}>
                <div className="container mx-auto px-6 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex gap-2">
                        ...
                        <NavLink to="/giheung-highpub-guide" label="하이퍼블릭" currentPath={location.pathname} />
                        <NavLink to="/giheung-karaoke-guide" label="가라오케" currentPath={location.pathname} />
                        <NavLink to="/giheung-shirtsroom-guide" label="셔츠룸" currentPath={location.pathname} />
                        <NavLink to="/giheung-kimono-room-guide" label="기모노룸" currentPath={location.pathname} />
                        <NavLink to="/giheung-room-salon-guide" label="룸살롱" currentPath={location.pathname} />
                        <NavLink to="/giheung-hostbar-guide" label="호빠" currentPath={location.pathname} />
                        <div className="w-px h-4 bg-slate-800 my-auto mx-2"></div>
            ...
            <footer className="bg-slate-950 border-t border-slate-900 py-16 pb-32 md:pb-16 text-center text-slate-500 text-sm">
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-2xl mx-auto mb-8">
                        ...
                        <p className="text-xs text-slate-600 font-medium">기흥 유흥의 모든 것, 서우 실장 | 대표: 서우 | 사업자등록번호: 000-00-00000 | 010-2626-4833</p>
                    </div>

                    <p className="opacity-30 text-xs">© COPYRIGHT 2026, 기흥 서우실장. ALL RIGHTS RESERVED.</p>
                </div>
            </footer>
