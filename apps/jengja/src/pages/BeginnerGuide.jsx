        ...
        "step": [
            {
                ...
                "image": "https://jeongja.vip/step1-call.jpg",
                "url": "https://jeongja.vip/jeongja-entertainment-beginner-guide#step1"
            },
            {
                "@type": "HowToStep",
                "name": "업소 방문 및 룸 배정",
                "text": "약속된 시간에 업소에 도착하여 담당 실장을 찾습니다. 인원에 맞는 룸으로 안내받습니다.",
                "image": "https://jeongja.vip/step2-room.jpg",
                "url": "https://jeongja.vip/jeongja-entertainment-beginner-guide#step2"
            },
            {
                "@type": "HowToStep",
                "name": "초이스(Choice) 진행",
                "text": "담당 실장이 매니저들을 보여드립니다(매직미러 또는 조별 입장). 마음에 드는 파트너를 선택합니다.",
                "image": "https://jeongja.vip/step3-choice.jpg",
                "url": "https://jeongja.vip/jeongja-entertainment-beginner-guide#step3"
            },
            {
                "@type": "HowToStep",
                "name": "음주가무 및 파트너 케어",
                "text": "정해진 시간 동안 술과 노래를 즐기며 파트너와 즐거운 시간을 보냅니다.",
                "image": "https://jeongja.vip/step4-party.jpg",
                "url": "https://jeongja.vip/jeongja-entertainment-beginner-guide#step4"
            },
            {
                "@type": "HowToStep",
                "name": "계산 및 귀가",
                "text": "시간이 종료되면 계산서를 확인하고 결제합니다. 대리운전이나 픽업 차량을 요청하여 안전하게 귀가합니다.",
                "image": "https://jeongja.vip/step5-pay.jpg",
                "url": "https://jeongja.vip/jeongja-entertainment-beginner-guide#step5"
            }
        ]
    };
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image" content="https://jeongja.vip/og-beginner.jpg" />
                ...
                <meta property="twitter:image" content="https://jeongja.vip/og-beginner.jpg" />
                <link rel="canonical" href="https://jeongja.vip/jeongja-entertainment-beginner-guide" />
            </Helmet>
