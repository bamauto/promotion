...
const PriceGuide = () => {
    return (
        <>
            <Helmet>
                <title>평택 유흥 가격 가이드 | 주대 18만원 이상 기준</title>
                <meta name="description" content="평택 유흥 가격 가이드. 하이퍼블릭·가라오케·룸살롱·셔츠룸 기준을 정리했습니다. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta name="keywords" content="평택 유흥 가격, 평택 주대, 평택 TC, 평택 하이퍼블릭 가격" />
                <meta property="og:title" content="평택 유흥 가격 가이드 | 주대 18만원 이상 기준" />
                <meta property="og:description" content="평택 유흥 가격 가이드. 하이퍼블릭·가라오케·룸살롱·셔츠룸 기준을 정리했습니다. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="og:image" content="https://pt-karaoke.com/og-price.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="평택 유흥 가격 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="평택 유흥 가격 가이드 | 주대 18만원 이상 기준" />
                <meta property="twitter:description" content="평택 유흥 가격 가이드. 하이퍼블릭·가라오케·룸살롱·셔츠룸 기준을 정리했습니다. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="twitter:image" content="https://pt-karaoke.com/og-price.jpg" />
                <link rel="canonical" href="https://pt-karaoke.com/pyeongtaek-entertainment-price-guide" />
            </Helmet>
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950 px-4 pb-20">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400 text-lg leading-relaxed max-w-3xl mx-auto">평택 상권 기준 주대/TC 기준을 한눈에 정리했습니다.<br />평택역·평택역 상권 중심 업소 기준으로 안내하며 상세 견적은 문의 부탁드립니다.</p>
                    </div>
                                ...
                                <tbody className="text-slate-300 divide-y divide-slate-800">
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        <td className="py-4 px-6 font-bold text-amber-400">
                                            <Link to="/pyeongtaek-hyperpub-guide" className="hover:underline">하이퍼블릭</Link>
                                        </td>
                                        <td className="py-4 px-6">주대 18만원 이상</td>
                                        <td className="py-4 px-6">TC 10만원 이상</td>
                                        <td className="py-4 px-6 text-sm">평택역·평택역 상권 라인 중심, 평택·평택 테크 직장인 선호. 프라이빗 라운지 타입.</td>
                                    </tr>
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        ...
                                        <td className="py-4 px-6">주대 18만원 이상</td>
                                        <td className="py-4 px-6">TC 10만원 이상</td>
                                        <td className="py-4 px-6 text-sm">평택역 상권 인근 감각적인 분위기, 빠른 초이스.</td>
                                    </tr>
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        ...
                                        <td className="py-4 px-6">주대 18만원 이상</td>
                                        <td className="py-4 px-6">TC 10만원 이상</td>
                                        <td className="py-4 px-6 text-sm">평택 산업단지 파티/회식 수요 중심, 대형 룸 구성.</td>
                                    </tr>
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        <td className="py-4 px-6 font-bold text-amber-600">
                                            <Link to="/pyeongtaek-room-salon-guide" className="hover:underline">정통 룸살롱</Link>
                                        </td>
                                        <td className="py-4 px-6">주대 18만원 이상</td>
                                        <td className="py-4 px-6">TC 10만원 이상</td>
                                        <td className="py-4 px-6 text-sm">평택역 비즈니스 접대 중심, 조용한 룸.</td>
                                    </tr>
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        ...
                                        <td className="py-4 px-6">주대 18만원 이상</td>
                                        <td className="py-4 px-6">TC 10만원 이상</td>
                                        <td className="py-4 px-6 text-sm">구성역 주변 여성 고객 맞춤 라운지.</td>
                                    </tr>
</tbody>
                            </table>
                        </div>
                        <div className="p-4 bg-slate-800/50 text-xs text-slate-500 text-center">
                            * 주대 18만원 이상, TC 10만원 이상 기준이며 업소/시간/인원에 따라 변동됩니다. 평택 상세 견적은 전화 문의 바랍니다.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                            ...
                            <ul className="space-y-4 text-slate-300">
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        평택 기준은 기본 주류 1병과 안주/음료 포함 세트이며, 추가 병은 별도 청구됩니다.
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <CheckCircle className="text-green-500 flex-shrink-0 mt-1" size={20} />
                        ...
                        <div className="bg-amber-900/10 p-8 rounded-2xl border border-amber-500/20">
                            ...
                            <p className="text-slate-300 mb-4 leading-relaxed">평택 상권에서도 일부 비양심적인 영업진들이 손님이 술에 취한 틈을 타 <strong>'술병 늘리기'</strong>를 하거나, 계산서에 안 먹은 안주를 몰래 넣는 경우가 있습니다.</p>
                            <p className="text-slate-300 mb-6 leading-relaxed">서우실장은 <strong>'정찰제 가격표'</strong>를 미리 보여드리고 시작하며, 평택역·평택역 상권 중심 업소 기준으로 계산 시 드신 내역을 투명하게 확인시켜 드립니다.</p>
                            <div className="bg-slate-950 p-4 rounded-xl border border-amber-500/30 text-amber-200 text-sm font-bold text-center">
                                "저렴하다고 무조건 좋은 게 아닙니다. 믿을 수 있는 사람을 찾으세요. (평택 기준)"
                            </div>
                        </div>
                    </div>
