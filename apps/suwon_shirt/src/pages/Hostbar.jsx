...
const venues = {
    hostbar: [
        ...
        },
        {
            ...
            location: '인계동 상권 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '인계동 상권 중심 감각적인 호빠. 감각적인 분위기와 포토존.',
            features: ['포토존', '감각적인 무드', '인계동 상권 중심', '트렌디'],
            img: venueImg2,
            imgAlt: '수원 호빠 인계동 상권 추천',
        }
    ]
};
...
const Hostbar = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "수원 호빠 예약 안내. 인계동 상권·삼성 디지털시티 여성전용 라운지, 주대 18만원 이상/TC 10만원 이상.",
        "https://suwonshirt.com/suwon-shirt-hostbar-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>수원 호빠 | 수원역 여성 전용 라운지 완벽 가이드</title>
                <meta name="description" content="수원 호빠 완전 가이드. 수원역·삼성 디지털시티 여성 전용 프리미엄 라운지. 수원·인계동 여성 직장인 힐링·네트워킹 맞춤. 안정적·편안한 분위기. 상담 010-2626-4833" />
                <meta name="keywords" content="수원 호빠, 수원 호스트바, 수원 호빠 예약, 수원 가라오케" />
                <meta property="og:title" content="수원 호빠 | 수원역 여성 전용 라운지 완벽 가이드" />
                <meta property="og:description" content="수원 호빠 완전 가이드. 수원역·삼성 디지털시티 여성 전용 프리미엄 라운지. 수원·인계동 여성 직장인 힐링·네트워킹 맞춤. 안정적·편안한 분위기. 상담 010-2626-4833" />
                <meta property="og:image" content="https://suwonshirt.com/og-hostbar.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="수원 호빠 | 수원역 여성 전용 라운지 완벽 가이드" />
                <meta property="twitter:description" content="수원 호빠 완전 가이드. 수원역·삼성 디지털시티 여성 전용 프리미엄 라운지. 수원·인계동 여성 직장인 힐링·네트워킹 맞춤. 안정적·편안한 분위기. 상담 010-2626-4833" />
                <meta property="twitter:image" content="https://suwonshirt.com/og-hostbar.jpg" />
                <link rel="canonical" href="https://suwonshirt.com/suwon-shirt-hostbar-guide" />
            </Helmet>
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    ...
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">수원 호빠(호스트바)는 인계동 상권·삼성 디지털시티 중심 여성 고객 라운지로 운영됩니다.<br />프라이빗 코스와 맞춤 대화 중심으로 안내합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>
