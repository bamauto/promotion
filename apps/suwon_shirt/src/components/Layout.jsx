                ...
                <div className="container mx-auto px-6 flex items-center justify-between">
                    <Link to="/" className="flex items-center gap-2 cursor-pointer group">
                        ...
                        <div className="flex flex-col">
                            <span className="text-xs text-amber-500 font-bold tracking-widest uppercase">프리미엄 셔츠룸</span>
                    ...
                    <nav className="hidden md:flex gap-2">
                        ...
                        <NavLink to="/suwon-shirt-shirtsroom-guide" label="셔츠룸" currentPath={location.pathname} />
                        <NavLink to="/suwon-shirt-highpub-guide" label="하이퍼블릭" currentPath={location.pathname} />
                        <NavLink to="/suwon-shirt-karaoke-guide" label="가라오케" currentPath={location.pathname} />
                        <NavLink to="/suwon-shirt-kimono-room-guide" label="기모노룸" currentPath={location.pathname} />
                        <NavLink to="/suwon-shirt-room-salon-guide" label="룸살롱" currentPath={location.pathname} />
                        <NavLink to="/suwon-shirt-hostbar-guide" label="호빠" currentPath={location.pathname} />
                        <div className="w-px h-4 bg-slate-800 my-auto mx-2"></div>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex justify-center items-center gap-2 mb-6">
                        <div className="w-8 h-8 bg-black rounded-lg flex items-center justify-center border border-slate-800 shadow-lg transition-transform hover:scale-110">
                            <img src="/logo.webp" alt="서우실장 로고" className="w-5 h-5 grayscale-0 brightness-110" />
                        </div>
                        <span className="text-xl font-bold text-white tracking-tight">서우실장</span>
                    </div>
                    ...
                    <div className="max-w-2xl mx-auto mb-8">
                        <p className="text-slate-400 leading-relaxed mb-4 italic">
                            ...
                            수원 셔츠룸의 품격 있는 기준, 믿음직한 파트너로서<br />
                        ...
                        <p className="text-xs text-slate-600 font-medium">수원 셔츠룸의 모든 것, 서우 실장 | 대표: 서우 | 사업자등록번호: 000-00-00000 | 010-2626-4833</p>
                    </div>

                    <p className="opacity-30 text-xs">© COPYRIGHT 2026, 수원 셔츠룸 서우실장. ALL RIGHTS RESERVED.</p>
                </div>
            </footer>
