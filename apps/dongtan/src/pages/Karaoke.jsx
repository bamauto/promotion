    ...
    karaoke: [
        {
            ...
            price: '기본가 100,000원 ~',
            desc: '동탄2 로데오거리의 랜드마크. 최대 30명 수용 가능한 대형 파티룸을 완비하여 반도체 기업 회식이나 동호회 모임에 제격입니다. 최신 사이키 조명과 클럽 사운드 시스템으로 열광적인 분위기를 연출합니다.',
            features: ['30인 대형룸', '클럽 조명', 'DJ 섭외 가능', '24시간 운영'],
            img: '/dongtan-highpublic-2.webp',
            imgAlt: '동탄 가라오케 A점 대형 파티룸'
        },
        {
            id: 'k-2',
            name: '동탄 가라오케 B점',
            type: 'Luxury Lounge',
            location: '동탄역 인근 카페거리',
            price: '기본가 150,000원 ~',
...
const Karaoke = () => {
    ...
    return (
        <>
            <Helmet>
                <title>동탄 가라오케 가격 예약 | 동탄역·동탄2 NO.1 서우실장</title>
                <meta name="description" content="동탄 가라오케 TOP 6 완벽 가이드. 동탄역·동탄2·반송동·영천동 고급 음향시설. 파티룸·VIP룸·생일파티·회식 특화. 삼성전자·SK하이닉스 직장인 선호. 단체 환영 | 24시간 예약 ☎ 010-2626-4833" />
