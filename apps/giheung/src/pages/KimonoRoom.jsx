...
const KimonoRoom = () => {
    ...
    return (
        <>
            <Helmet>
                <title>기흥 기모노룸 예약 | 기흥역·삼성전자 기흥캠퍼스 테마</title>
                <meta name="description" content="기흥 기모노룸 테마 가이드. 기흥역·삼성전자 기흥캠퍼스 중심 이색 무드와 포토 포인트. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta name="keywords" content="기흥 기모노룸, 기흥 기모노룸 예약, 기흥 룸살롱, 기흥 하이퍼블릭" />
                <meta property="og:title" content="기흥 기모노룸 예약 | 기흥역·삼성전자 기흥캠퍼스 테마" />
                <meta property="og:description" content="기흥 기모노룸 테마 가이드. 기흥역·삼성전자 기흥캠퍼스 중심 이색 무드와 포토 포인트. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                ...
                <meta property="twitter:title" content="기흥 기모노룸 예약 | 기흥역·삼성전자 기흥캠퍼스 테마" />
                <meta property="twitter:description" content="기흥 기모노룸 테마 가이드. 기흥역·삼성전자 기흥캠퍼스 중심 이색 무드와 포토 포인트. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
