    ...
    roomSalon: [
        {
            ...
            imgAlt: '동탄 로얄 비즈니스 룸살롱 - 삼성전자 SK하이닉스 임원 접대'
        },
        {
            id: 'rs-2',
            name: '동탄 룸살롱 - 레거시 클럽',
            type: 'Traditional Luxury',
            location: '동탄2 신도시 AK플라자 인근',
            ...
            imgAlt: '동탄 레거시 클럽 룸살롱 - 동탄2 신도시 프리미엄'
        }
    ]
};
...
const RoomSalon = () => {
    ...
    return (
        <>
            <Helmet>
                <title>동탄 룸살롱·VVIP접대 완벽가이드 | 비즈니스 성공 전략</title>
                <meta name="description" content="동탄 프리미엄 룸살롱 가이드. 삼성전자·SK하이닉스 반도체·IT임원 비즈니스 접대 특화. VVIP룸·통역매니저·법인카드결제·세금계산서 발행. 바이어접대·계약잔치 완벽정리. 보안철저 | 24시간 ☎ 010-2626-4833" />
