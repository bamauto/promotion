    ...
    roomSalon: [
        {
            ...
            imgAlt: '영통 로얄 비즈니스 룸살롱'
        },
        {
            id: 'rs-2',
            name: '영통 룸살롱 - 레거시 클럽',
            type: 'Traditional Luxury',
            location: '영통 수원역 AK플라자 인근',
...
const RoomSalon = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Jeongja Room Salon",
        "영통 최고급 정통 룸살롱 예약 및 비즈니스 접대 가이드.",
    ...
    return (
        <>
            <Helmet>
                <title>영통 룸살롱 | 비즈니스 접대·예약가이드</title>
                <meta name="description" content="영통역·영통동 고급 룸살롱 선택 기준 및 효과적 활용법 | 바이어 접대·클라이언트 관계 구축 전략 | 비즈니스 파트너 선정 가이드 | 접대 매너·에티켓·비용 효율화 팁" />
                <meta name="keywords" content="영통역 룸살롱, 영통역 접대, 영통 룸살롱 가이드, 비즈니스 접대 전략, 라운지 문화, 접대 매너, 접대 에티켓, 클라이언트 접대, 바이어 관계 구축, 비용 효율화, 영통동 라운지, 수원 고급 라운지" />
                <meta property="og:title" content="영통역 룸살롱 비즈니스 접대 가이드 | 완벽 매너" />
                ...
                <meta property="og:image:alt" content="영통 룸살롱 비즈니스 접대 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="영통 룸살롱 접대 가이드" />
                        ...
                        <div className="mt-16">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    ...
                                    { src: '/partner/rs-gallery-03.webp', alt: '영통 룸살롱 프리미엄 서비스 - 수원시 정통' },
                                ].map((img, idx) => (
