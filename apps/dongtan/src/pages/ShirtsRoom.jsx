    ...
    shirtsRoom: [
        {
            ...
            location: '영천동 인근 1번 출구',
            price: '룸티 30,000원 ~',
            desc: '정통 셔츠룸의 강자. "셔츠는 핏이다"라는 슬로건 아래 체계적인 사이즈 관리와 스타일링 서비스를 제공합니다. 동탄 최대 규모로 언제 가도 대기 없이 즐기실 수 있습니다.',
            features: ['전원 화이트 셔츠', '20대 초중반', '동탄 최대 규모', '주차 100%'],
            img: '/dongtan-karaoke-2.webp',
            imgAlt: '동탄 셔츠룸 A점 프리미엄 룸'
        },
        {
            id: 's-2',
            name: '동탄 셔츠룸 B점',
        ...
        },
        {
            ...
            location: '반송동 인근',
            price: '룸티 35,000원 ~',
            desc: '동탄 직장인을 위한 비즈니스 최적화 룸. 깔끔하고 쾌적한 인테리어에서 편안하게 접대하거나 회식을 즐길 수 있습니다.',
            features: ['조용한 분위기', '비즈니스 접대', '단체석 완비', '법카 환영'],
            img: '/dongtan-nightlife-2.webp',
            imgAlt: '동탄 셔츠룸 C점 비즈니스 룸'
        },
        {
            id: 's-4',
            name: '동탄 셔츠룸 D점',
            type: 'Hard Core',
            location: '동탄역 인근 중심상가',
            price: '문의 필요',
...
const ShirtsRoom = () => {
    ...
    return (
        <>
            <Helmet>
                <title>동탄 셔츠룸·화이트셔츠 완벽가이드 | 비즈니스·회식 BEST 4곳</title>
                <meta name="description" content="동탄 셔츠룸 초보자가이드. 화이트셔츠 컨셉·이색감성·높은수위. 동탄역·동탄2·반송동 4개업소 추천. 삼성전자·SK하이닉스 직장인 비즈니스접대·화끈한회식·친구모임 맞춤. 투명한정찰제 | 24시간 ☎ 010-2626-4833" />
