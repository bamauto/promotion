...
const Hostbar = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "인계동 호스트바 추천 및 가격. 여성 전용 프라이빗 룸 및 픽업 서비스.",
        "https://www.ingedongkaraoke.com/ingedong-hostbar-guide",
        "150000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>여성 맞춤형 라운지 선택 가이드 | 인계동 호스트바 문화 이해</title>
                <meta name="description" content="여성 고객을 위한 프리미엄 라운지 문화 이해 | 서비스 형식·분위기·비용·장점 완벽 정복 | 호스트바 이용 에티켓과 팁 | 안전하고 즐거운 경험을 위한 체크리스트" />
                <meta name="keywords" content="인계동 호스트바 가이드, 여성 라운지 문화, 호스트바 이해, 라운지 경험, 여성 친화 클럽, 호스트바 매너, 안전한 라운지, 라운지 에티켓, 비용 기준, 선택 가이드" />
                <meta property="og:title" content="인계동 호스트바 문화 가이드 | 여성 라운지 선택" />
                <meta property="og:description" content="호스트바 문화 이해 | 안전한 이용 가이드 | 에티켓과 팁" />
                <meta property="og:image" content="https://www.ingedongkaraoke.com/og-hostbar.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="인계동 호스트바 문화 가이드" />
                <meta property="twitter:description" content="여성 라운지 선택 | 안전 이용 | 에티켓 안내" />
                <meta property="twitter:image" content="https://www.ingedongkaraoke.com/og-hostbar.jpg" />
                <link rel="canonical" href="https://www.ingedongkaraoke.com/ingedong-hostbar-guide" />
            </Helmet>
