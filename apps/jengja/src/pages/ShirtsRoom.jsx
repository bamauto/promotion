...
const ShirtsRoom = () => {
    ...
    const serviceSchema = generateServiceSchema(
        ...
        "https://jeongja.vip/jeongja-shirtsroom-guide",
        "130000"
    );
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="twitter:image" content="https://jeongja.vip/og-shirtsroom.jpg" />
                <link rel="canonical" href="https://jeongja.vip/jeongja-shirtsroom-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="정자 셔츠룸 시스템 가이드" subtitle="White Shirt Fantasy" />
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-blue-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 정자 셔츠룸 추천 업소</h2>
                        </div>
