...
const HyperPublicFAQ = () => {
    const faqList = [
        ...
        },
        {
            ...
            answer: "네, 인계동 하이퍼블릭 방문객의 약 40%가 1인 손님입니다. 가격 차이는 없으며, 오히려 1:1로 집중적인 케어를 받으실 수 있어 만족도가 높습니다. 어색하지 않게 담당 실장이 케어해 드립니다."
        },
        {
        ...
        },
        {
            ...
            answer: "인계동 전 지역(매탄동, 원천동, 영통, 권선동, 인계동, 권선동, 원천동, 광교) 어디든 24시간 무료 픽업 차량을 보내드립니다. 예약 시 계신 곳 위치만 알려주세요."
        },
        {
            question: "복장 제한이 있나요?",
