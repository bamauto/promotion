...
const RoomSalonFAQ = () => {
    const faqList = [
    {
        question: "정자 룸살롱의 특징은 무엇인가요?",
        answer: "조용한 대화와 비즈니스 접대에 초점을 둔 프라이빗 룸 중심 서비스입니다. (정자 상권 기준)"
    },
    {
        question: "접대나 회의 목적도 가능한가요?",
        answer: "네. 정자·판교 테크 직장인 접대 수요가 많아 비즈니스 라운지 타입도 운영합니다."
    },
    {
        question: "픽업 지원은 어디까지 되나요?",
        answer: "정자역, 정자 카페거리, 판교테크노밸리, 미금역 중심 픽업을 안내합니다."
    },
    {
        question: "주대/TC 기준은 어떻게 되나요?",
        answer: "주대 18만원 이상, TC 10만원 이상 기준이며 코스에 따라 달라집니다. (정자 상권 기준)"
    },
    {
        question: "예약은 필수인가요?",
    ...
    },
    {
        ...
        answer: "비즈니스 목적이라면 포멀한 복장이 추천되며, 일반 캐주얼도 가능합니다. (정자 상권 기준)"
    }
];
    ...
    return (
        <>
            <Helmet>
                <title>정자 룸살롱 FAQ | 접대·예약·가격 안내</title>
                <meta name="description" content="정자 룸살롱 FAQ. 비즈니스 접대, 예약 방법, 주대/TC 기준을 정리했습니다." />
                <meta name="keywords" content="정자 룸살롱 FAQ, 정자 룸살롱 예약, 정자 룸살롱 가격" />
                <link rel="canonical" href="https://jengjakaraoke.com/jeongja-room-salon-guide/faq" />
            </Helmet>
                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="mt-16 text-center">
                        <div className="flex flex-col md:flex-row justify-center gap-4">
                            ...
                            <Link to="/jeongja-room-salon-guide" className="bg-slate-800 hover:bg-slate-700 text-white font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-2 transition-all">
                                <ChevronRight size={20} /> 정자 룸살롱 정보 더보기
                            </Link>
                        </div>
                    </div>
                </div>
