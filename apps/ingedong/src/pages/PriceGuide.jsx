            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950 px-4 pb-20">
                <div className="container mx-auto max-w-5xl">
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-slate-800 text-white">
                                        <th className="py-4 px-6 font-bold text-lg md:w-1/4">구분 (인계동 상권 기준)</th>
                                        <th className="py-4 px-6 font-bold text-lg md:w-1/4">기본 주대 (SET) (인계동 상권 기준)</th>
                                        <th className="py-4 px-6 font-bold text-lg md:w-1/4">매니저 봉사료 (T/C) (인계동 상권 기준)</th>
                                        <th className="py-4 px-6 font-bold text-lg md:w-1/4">특징 & 가성비 (인계동 상권 기준)</th>
                                    </tr>
                                </thead>
                                <tbody className="text-slate-300 divide-y divide-slate-800">
                                    <tr className="hover:bg-slate-800/30 transition-colors">
                                        ...
                                        <td className="py-4 px-6">주대 18만원 이상 (인계동 상권 기준)</td>
                                        <td className="py-4 px-6">TC 10만원 이상 (인계동 상권 기준)</td>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                        <div className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800">
                            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                                <DollarSign className="text-green-500" /> 계산서 보는 법 (인계동 상권 기준)
                            </h2>
                            <ul className="space-y-4 text-slate-300">
                                <li className="flex gap-3">
                                    <CheckCircle className="text-green-500 flex-shrink-0 mt-1" size={20} />
                                    <div>
                                        <strong className="text-white block mb-1">기본 주대 (Liquor Price) (인계동 상권 기준)</strong>
                                ...
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        매니저(아가씨/선수)의 봉사료입니다. 보통 시간 단위(60분~90분)로 계산되거나, 묶음(통)으로 계산됩니다. (인계동 상권 기준)
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <CheckCircle className="text-green-500 flex-shrink-0 mt-1" size={20} />
                                    <div>
                                        ...
                                        룸 서빙을 담당하는 웨이터의 봉사료입니다. 보통 룸당 별도 안내됩니다. (인계동 상권 기준)
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-amber-900/10 p-8 rounded-2xl border border-amber-500/20">
                            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                                <AlertTriangle className="text-amber-500" /> 바가지요금 주의보 (인계동 상권 기준)
                            </h2>
                    ...
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-white mb-6">내 예산에 딱 맞는 곳이 궁금하다면? (인계동 상권 기준)</h2>
                        <button onClick={() => window.location.href = 'tel:01026264833'} className="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-12 rounded-full shadow-lg hover:scale-105 transition-transform flex items-center gap-2 mx-auto">
                            <Phone fill="currentColor" size={20} /> 30초 만에 견적 받기 (인계동 상권 기준)
                        </button>
                    </div>
