...
const Home = () => {
    ...
    const venues = [
        { id: 'ingedong-karaoke-guide', title: '가라오케', sub: '프리미엄 / 라운지', img: '/karaoke_main.webp', desc: '최신 음향 시설과 프라이빗 룸' },
        { id: 'ingedong-hyperpublic-guide', title: '하이퍼블릭', sub: '프라이빗 / 시크릿', img: '/highpublic_main.webp', desc: '트렌디한 분위기와 감각적인 서비스' },
        { id: 'ingedong-shirtsroom-guide', title: '셔츠룸', sub: '초이스 / 화이트셔츠', img: '/shirtsroom_main.webp', desc: '색다른 컨셉의 이색적인 경험' },
        { id: 'ingedong-kimono-room-guide', title: '기모노룸', sub: '이색 테마 / 코스프레', img: '/kimonoroom_main.webp', desc: '매혹적인 일본 전통 의상 테마' },
        { id: 'ingedong-room-salon-guide', title: '룸살롱', sub: '정통 / 비즈니스', img: '/roomsalon_main.webp', desc: '성공적인 비즈니스를 위한 격조 높은 공간' },
        { id: 'ingedong-hostbar-guide', title: '호빠', sub: '프리미엄 / 여성전용', img: '/hostbar_main.webp', desc: '여성 고객을 위한 품격있는 서비스' }
    ];
    ...
    return (
        <>
            <Helmet>
                <title>인계동 가라오케 완벽 가이드 | 하이퍼블릭·룸살롱·셔츠룸 비교분석</title>
                <meta name="description" content="인계동 가라오케·하이퍼블릭 프리미엄 가이드 | 영통·광교 지역별 특징 분석 | 용도별·예산별 선택 기준 제시 | 초보자를 위한 이용 가이드 및 에티켓" />
            ...
            <section id="features" className="py-24 bg-slate-950 container mx-auto px-4 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <FeatureItem icon={Car} title="편리한 이동 지원" desc="인계동·영통·광교 전 지역 이동 편의를 위한 픽업 서비스를 운영합니다." delay={300} />
                </div>
            </section>
