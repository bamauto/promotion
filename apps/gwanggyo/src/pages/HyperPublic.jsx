    ...
    hyperPublic: [
        {
            ...
            location: '광교 광교동 카페거리 인근',
            price: '양주 SET 200,000원 ~',
            desc: '광교동 특유의 고급스러운 분위기를 그대로 담았습니다. 전 룸 명품관 스타일의 인테리어와 프리미엄 식기 사용. VVIP 비즈니스 접대에 최적화된 럭셔리 공간입니다.',
            features: ['발렛 파킹', '호텔급 룸서비스', '테라스 룸', '외국어 가능 매니저'],
            img: venueImg1,
            imgAlt: '광교 프리미엄 하이퍼블릭 인테리어'
        },
        {
            id: 'hp-2',
            name: '광교동 하이퍼블릭 라운지',
            type: 'Mega Size',
            location: '광교 광교중앙역 로데오거리',
            price: '양주 SET 180,000원 ~',
            desc: '60개의 룸을 보유한 광교 최대 규모 하이퍼블릭. 바다를 테마로 한 청량감 있는 인테리어와 20대 초반 위주의 영(Young)한 매니저 라인업이 특징입니다.',
            features: ['최대 규모', 'EDM 파티 타임', '생일 샴페인 증정', '합석 가능'],
            img: venueImg2,
            imgAlt: '광교동 하이퍼블릭 라운지 인테리어'
        }
    ]
};
...
const HyperPublic = () => {
    const faqList = [
        ...
        },
        {
            ...
            answer: "대부분의 프리미엄 펍은 광교 시내 주요 지역(광교동, 분당, 판교)에서 무료 픽업을 제공합니다. 다만 대기 시간이 길거나 먼 지역은 추가 요금이 발생할 수 있으니 사전 확인이 필요합니다."
        },
        {
    ...
    const serviceSchema = generateServiceSchema(
        "HyperPublic Club",
        "광교 하이퍼블릭 예약 및 가격 안내. 24시간 픽업 서비스 및 최신 시설 완비.",
    ...
    return (
        <>
            <Helmet>
                <title>광교 하이퍼블릭 | 프라이빗 펍 선택가이드</title>
                <meta name="description" content="광교중앙역·광교동 프리미엄 광교 하이퍼블릭 추천. 프라이빗한 분위기와 감각적 서비스. 광교 하이퍼블릭 투명한 가격 18만원~. 광교중앙역 하이퍼블릭 예약 ☎ 010-2626-4833" />
                <meta name="keywords" content="광교 하이퍼블릭, 광교중앙역 하이퍼블릭, 광교동 하이퍼블릭, 광교 프라이빗 펍, 광교 하이퍼블릭 가격, 광교 하이퍼블릭 추천, 상현역 하이퍼블릭, 광교 프리미엄 펍, 광교 밤문화, 광교 하이퍼블릭 위치, 광교 비즈니스 라운지" />
                <meta property="og:title" content="광교 하이퍼블릭 | 프라이빗 펍 선택가이드" />
                <meta property="og:description" content="광교중앙역·광교동 프리미엄 광교 하이퍼블릭 추천. 프라이빗한 분위기와 감각적 서비스. 투명한 가격 18만원~." />
                <meta property="og:image" content="https://gwanggyokaraoke.com/og-highpub.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="광교 하이퍼블릭 선택 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="광교 하이퍼블릭 | 프라이빗 펍 선택가이드" />
                <meta property="twitter:description" content="광교중앙역·광교동 프리미엄 하이퍼블릭 추천. 프라이빗한 분위기, 가격 18만원~." />
                        ...
                        <div className="mt-16">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    ...
                                    { src: '/partner/hp-gallery-03.webp', alt: '광교 하이퍼블릭 최고급 파트너 - 분당 광교중앙역 인근' },
