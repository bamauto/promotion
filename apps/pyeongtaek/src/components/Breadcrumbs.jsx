...
const routeNameMap = {
    'pyeongtaek-highpub-guide': '하이퍼블릭',
    'pyeongtaek-karaoke-guide': '가라오케',
    'pyeongtaek-shirtsroom-guide': '셔츠룸',
    'pyeongtaek-kimono-room-guide': '기모노룸',
    'pyeongtaek-room-salon-guide': '룸살롱',
    'pyeongtaek-hostbar-guide': '호빠',
    'pyeongtaek-entertainment-price-guide': '가격 가이드',
    'pyeongtaek-entertainment-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://pt-karaoke.com${routeTo}`
        });
    });
