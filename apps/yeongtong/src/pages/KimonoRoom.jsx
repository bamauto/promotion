...
const KimonoRoom = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Kimono Room",
        "영통 기모노룸 예약 및 가격. 기모노 의상 테마의 이색 프리미엄 룸살롱.",
    ...
    return (
        <>
            <Helmet>
                <title>영통 기모노룸 | 테마 라운지 이용가이드</title>
                <meta name="description" content="영통역·영통동 기모노 테마 라운지 경험 완벽 가이드 | 컨셉 이해·분위기·가격·이용 방법 비교 | 테마 라운지 문화 탐색 | 색다른 경험을 위한 선택 팁" />
                <meta name="keywords" content="영통역 기모노룸, 영통역 테마라운지, 영통 기모노룸, 테마 라운지, 문화 경험, 특색 있는 바, 이색 체험, 라운지 컨셉, 테마별 라운지, 새로운 경험, 라운지 선택, 특별한 밤, 컨셉 라운지 이용법" />
                <meta property="og:title" content="영통 기모노룸 테마 라운지 가이드 | 영통역 이색 체험" />
                ...
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    ...
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">
                            영통 도심 속에서 만나는 <strong className="text-rose-400">작은 일본</strong>.<br />
