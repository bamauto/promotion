                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="text-slate-300 space-y-8 leading-relaxed text-sm md:text-base">
                        <section>
                            ...
                            <p>
                                본 약관은 안양 서우실장(이하 "회사")이 제공하는 웹사이트 및 제반 서비스(이하 "서비스")의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-2">
                                <li>"서비스"라 함은 구현되는 단말기(PC, 휴대형단말기 등)와 상관없이 회원이 이용할 수 있는 안양 서우실장 관련 제반 서비스를 의미합니다.</li>
