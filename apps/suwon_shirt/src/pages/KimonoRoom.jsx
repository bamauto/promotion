...
const venues = {
    kimonoRoom: [
        ...
        },
        {
            ...
            location: '인계동 상권 인근',
            price: '주대 18만원 이상 · TC 10만원 이상, 상담 후 확정',
            desc: '인계동 상권 인근 모던 기모노룸. 고급스러운 무드와 세련된 연출.',
            features: ['모던 테마', '감각 연출', '인계동 상권 중심', '프라이빗'],
            img: venueImg2,
            imgAlt: '수원 기모노룸 인계동 상권 추천',
        }
    ]
};
...
const KimonoRoom = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Kimono Room",
        "수원 기모노룸 예약 안내. 수원역·삼성 디지털시티 테마, 주대 18만원 이상/TC 10만원 이상.",
        "https://suwonshirt.com/suwon-shirt-kimono-room-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>수원 기모노룸 | 수원역 테마 포인트 완벽 가이드</title>
                <meta name="description" content="수원 기모노룸 완전 가이드. 수원역 테마 의상·포토존 전문. 수원·인계동 직장인 이색 경험·특별한 날 맞춤. 테마·퓨전·모던 무드 선택. 상담 010-2626-4833" />
                <meta name="keywords" content="수원 기모노룸, 수원 기모노룸 예약, 수원 룸살롱, 수원 하이퍼블릭" />
                <meta property="og:title" content="수원 기모노룸 | 수원역 테마 포인트 완벽 가이드" />
                <meta property="og:description" content="수원 기모노룸 완전 가이드. 수원역 테마 의상·포토존 전문. 수원·인계동 직장인 이색 경험·특별한 날 맞춤. 테마·퓨전·모던 무드 선택. 상담 010-2626-4833" />
                <meta property="og:image" content="https://suwonshirt.com/og-kimono-room.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="수원 기모노룸 | 수원역 테마 포인트 완벽 가이드" />
                <meta property="twitter:description" content="수원 기모노룸 완전 가이드. 수원역 테마 의상·포토존 전문. 수원·인계동 직장인 이색 경험·특별한 날 맞춤. 테마·퓨전·모던 무드 선택. 상담 010-2626-4833" />
                <meta property="twitter:image" content="https://suwonshirt.com/og-kimono-room.jpg" />
                <link rel="canonical" href="https://suwonshirt.com/suwon-shirt-kimono-room-guide" />
            </Helmet>
            ...
            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    ...
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">수원 기모노룸은 수원역·삼성 디지털시티 테마 중심으로 이색 무드를 제공합니다.<br />포토 포인트와 테마 연출을 함께 즐기실 수 있습니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>
                        ...
                        <div className="mt-16">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                {[
                                    ...
                                    { src: '/partner/km-gallery-02.webp', alt: '수원 기모노룸 프리미엄 서비스 - 인계동 유카타 컨셉' },
                                    { src: '/partner/km-gallery-03.webp', alt: '수원 기모노룸 VIP 파트너 - 인계동 이색 체험' },
                                    { src: '/partner/km-gallery-04.webp', alt: '수원 기모노룸 최고급 매니저 - 서울근교 일본풍 테마' },
