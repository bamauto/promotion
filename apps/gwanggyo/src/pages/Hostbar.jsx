    ...
    hostbar: [
        {
            ...
            name: '광교 프리미엄 호빠',
            type: 'Wild & Sexy',
            location: '광교 광교중앙역 AK플라자 6번 게이트',
            price: '여성전용 특가',
            desc: '야성을 깨우는 짐승남들의 핫한 퍼포먼스. 광교중앙역 메인 상권에 위치하여 접근성이 좋으며, 파워풀하고 에너지 넘치는 선수들이 스트레스를 확실하게 풀어드립니다.',
            features: ['근육질 선수', '퍼포먼스 쇼', '생일 샴페인', '픽업 서비스'],
            img: venueImg1,
            imgAlt: '광교 프리미엄 호빠 인테리어'
        },
        {
            id: 'hb-2',
            name: '광교동 로맨틱 호빠',
            type: 'Flower Boys',
            location: '광교 광교동 엠코헤리츠',
            price: '풀코스 180,000원 ~',
...
const Hostbar = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "광교 호스트바 추천 및 가격. 여성 전용 프라이빗 룸 및 픽업 서비스.",
    ...
    return (
        <>
            <Helmet>
                <title>광교 호스트바·호빠 | 여성 전용 엔터</title>
                <meta name="description" content="광교 프리미엄 광교 호스트바·광교 호빠 추천. 여성 전용, 안전한 환경, 파워풀한 선수. 광교 호빠 스트레스 해소 전문. 광교중앙역 호빠 예약 ☎ 010-2626-4833" />
                <meta name="keywords" content="광교 호빠, 광교 호스트바, 광교중앙역 호빠, 광교동 호빠, 광교 호빠 가격, 광교 호빠 추천, 광교 여성 전용, 광교 호스트바 가격, 상현역 호빠, 광교 호빠 시스템" />
                <meta property="og:title" content="광교 호스트바·호빠 | 여성 전용 엔터" />
                <meta property="og:description" content="광교 프리미엄 호스트바·호빠 추천. 여성 전용, 안전한 환경, 파워풀한 선수. 스트레스 해소 전문." />
                ...
                <meta property="twitter:title" content="광교 호스트바 문화 가이드" />
