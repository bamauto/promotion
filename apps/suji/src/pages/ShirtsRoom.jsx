    ...
    shirtsRoom: [
        {
            ...
            desc: '수지역 인근 클래식 셔츠룸. 깔끔한 응대와 흐트러짐 없는 동선.',
            features: ['클래식 무드', '빠른 세팅', '수지역 접근', '기본에 충실'],
            img: '/suji-karaoke-2.webp',
            imgAlt: '수지 셔츠룸 수지역 추천',
        },
        {
            id: 's-2',
            name: '수지 셔츠룸 B점',
            ...
            location: '수지호수공원 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지호수공원 중심 모던 셔츠룸. 모던한 인테리어와 빠른 초이스.',
            features: ['모던 인테리어', '초이스 중심', '수지호수공원 중심', '경쾌한 분위기'],
            img: '/suji-highpublic-1.webp',
            imgAlt: '수지 셔츠룸 수지호수공원 추천',
        },
        {
            id: 's-3',
            name: '수지 셔츠룸 C점',
            ...
            location: '수지센트럴파크 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지센트럴파크 주변 프라이빗 타입. 대화 중심으로 차분하게 즐기는 코스.',
            features: ['프라이빗 룸', '대화 중심', '수지센트럴파크 인근', '차분한 코스'],
            img: '/suji-nightlife-2.webp',
            imgAlt: '수지 셔츠룸 수지센트럴파크 추천',
        },
        {
            id: 's-4',
            name: '수지 셔츠룸 D점',
            ...
            location: '상현역 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '상현역 인근 캐주얼 라인. 가볍게 시작하고 싶은 분께 추천.',
            features: ['캐주얼 라인', '유연한 타임', '상현역 인근', '가벼운 시작'],
            img: '/suji-hostbar-2.webp',
            imgAlt: '수지 셔츠룸 상현역 추천',
        }
    ]
};
...
const ShirtsRoom = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Shirts Room Club",
        "수지 셔츠룸 예약 안내. 죽전역·성복동 상권 중심, 주대 18만원 이상/TC 10만원 이상.",
        "https://sujikaraoke.com/suji-shirtsroom-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>수지 셔츠룸 | 성복동 고급 셔츠룸 예약</title>
                <meta name="description" content="수지 프리미엄 셔츠룸. 성복동 고급 상권 위치, 빠른 초이스. 비즈니스 접대 전문 ☎ 010-2626-4833" />
                <meta name="keywords" content="수지 셔츠룸, 성복동 셔츠룸, 죽전 셔츠룸, 수지구청역 셔츠룸, 용인 셔츠룸" />
                <meta property="og:title" content="수지 셔츠룸 | 성복동 고급 셔츠룸 예약" />
                <meta property="og:description" content="수지 프리미엄 셔츠룸. 성복동 고급 상권 위치, 빠른 초이스. 비즈니스 접대 전문." />
                <meta property="og:image" content="https://sujikaraoke.com/og-shirtsroom.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="수지 셔츠룸 | 성복동 고급 셔츠룸 예약" />
                <meta property="twitter:description" content="수지 프리미엄 셔츠룸. 성복동 고급 상권 위치, 빠른 초이스." />
                <meta property="twitter:image" content="https://sujikaraoke.com/og-shirtsroom.jpg" />
                <link rel="canonical" href="https://sujikaraoke.com/suji-shirtsroom-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="수지 셔츠룸 시스템 가이드" subtitle="White Shirt Fantasy" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">수지 셔츠룸은 죽전역·성복동 상권 중심 라인업으로 구성됩니다.<br />모던한 분위기와 빠른 초이스를 선호하시는 분께 적합합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>
                    ...
                    <ContentBlock id="definition" title="1. 셔츠룸이란?">
                        ...
                        <p>
                            수지 셔츠룸은 강남의 '란제리', '레깅스' 룸보다 진입 장벽이 낮으면서도, 퍼블릭보다 훨씬 과감하고 화끈한 노는 분위기를 형성합니다.
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-blue-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 수지 셔츠룸 추천 업소</h2>
                        </div>
                    ...
                    <div className="mt-16">
                        <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                            <Sparkles className="text-blue-500" /> 수지 셔츠룸 갤러리
                        </h3>
                        <div className="grid grid-cols-3 gap-4">
                            {[
                                { src: '/partner/sr-gallery-01.webp', alt: '수지 셔츠룸 프리미엄 매니저 - 수지역 VIP 서비스' },
                                { src: '/partner/sr-gallery-02.webp', alt: '수지 셔츠룸 최고급 파트너 - 메타폴리스 럭셔리 룸' },
                                { src: '/partner/sr-gallery-03.webp', alt: '수지 셔츠룸 VIP 매니저 - 수지신도시 프리미엄' },
                            ].map((img, idx) => (
                                <div key={idx} className="aspect-[3/4] rounded-2xl overflow-hidden border border-slate-800 hover:border-blue-500/50 transition-all duration-300 group">
                                    <img src={img.src} alt={img.alt} title="수지 셔츠룸 프리미엄 매니저" loading="lazy" width="300" height="400"
                    ...
                    <div className="bg-gradient-to-r from-blue-800 to-cyan-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">수지 비즈니스의 확실한 파트너</h2>
