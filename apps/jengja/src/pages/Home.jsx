...
const Home = () => {
    ...
    const venues = [
        { id: 'jeongja-highpub-guide', title: '하이퍼블릭', sub: '프라이빗 / 시크릿', img: '/highpublic_main.webp', desc: '정자역 중심 프라이빗 라운지' },
        { id: 'jeongja-karaoke-guide', title: '가라오케', sub: '프리미엄 / 라운지', img: '/karaoke_main.webp', desc: '정자 카페거리 파티/모임 룸' },
        { id: 'jeongja-shirtsroom-guide', title: '셔츠룸', sub: '초이스 / 화이트셔츠', img: '/shirtsroom_main.webp', desc: '판교테크노밸리 빠른 초이스' },
        { id: 'jeongja-kimono-room-guide', title: '기모노룸', sub: '이색 테마 / 코스프레', img: '/kimonoroom_main.webp', desc: '미금역 테마 포인트' },
        { id: 'jeongja-room-salon-guide', title: '룸살롱', sub: '정통 / 비즈니스', img: '/roomsalon_main.webp', desc: '정자역 비즈니스 라인' },
        { id: 'jeongja-hostbar-guide', title: '호빠', sub: '프리미엄 / 여성전용', img: '/hostbar_main.webp', desc: '정자 카페거리 여성전용 라운지' }
    ];
    ...
    return (
        <>
            <Helmet>
                <title>정자 가라오케·하이퍼블릭 예약 | 정자역·정자 카페거리 서우실장</title>
                <meta name="description" content="정자 가라오케·정자 하이퍼블릭 메인 가이드. 정자역·정자 카페거리 중심 상권에서 정자·판교 테크 직장인 맞춤 코스를 안내합니다. 정자 셔츠룸·호빠·기모노룸·룸살롱까지 한 번에. 주대 18만원 이상, TC 10만원 이상, 상세 문의. 24시간 상담 ☎ 010-2626-4833" />
                <meta name="keywords" content="정자 가라오케, 정자 하이퍼블릭, 정자 셔츠룸, 정자 호빠, 정자 기모노룸, 정자 룸살롱, 정자역 가라오케, 정자 카페거리 하이퍼블릭" />
                <meta property="og:title" content="정자 가라오케·하이퍼블릭 예약 | 정자역·정자 카페거리 서우실장" />
                <meta property="og:description" content="정자 가라오케·정자 하이퍼블릭 메인 가이드. 정자역·정자 카페거리 중심 상권에서 정자·판교 테크 직장인 맞춤 코스를 안내합니다. 정자 셔츠룸·호빠·기모노룸·룸살롱까지 한 번에. 주대 18만원 이상, TC 10만원 이상, 상세 문의. 24시간 상담 ☎ 010-2626-4833" />
                <meta property="og:image" content="https://jengjakaraoke.com/og-home.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="정자 하이퍼블릭·가라오케 메인 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="og:site_name" content="정자 유흥 가이드" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="정자 가라오케·하이퍼블릭 예약 | 정자역·정자 카페거리 서우실장" />
                <meta property="twitter:description" content="정자 가라오케·정자 하이퍼블릭 메인 가이드. 정자역·정자 카페거리 중심 상권에서 정자·판교 테크 직장인 맞춤 코스를 안내합니다. 정자 셔츠룸·호빠·기모노룸·룸살롱까지 한 번에. 주대 18만원 이상, TC 10만원 이상, 상세 문의. 24시간 상담 ☎ 010-2626-4833" />
                <meta property="twitter:image" content="https://jengjakaraoke.com/og-home.jpg" />
                <link rel="canonical" href="https://jengjakaraoke.com" />
            </Helmet>
                ...
                <div className="relative z-10 container mx-auto px-4 text-center mt-10">
                    <div className="animate-fade-in-up">
                        <span className="inline-flex items-center gap-2 border border-amber-500/30 bg-amber-900/10 backdrop-blur-md text-amber-400 px-6 py-2 rounded-full text-xs font-bold tracking-[0.2em] mb-8 uppercase hover:bg-amber-900/20 transition-colors cursor-default">
                            <Crown size={12} fill="currentColor" /> 정자 유흥 컨설팅 전문
                        </span>
                        ...
                        <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto mb-12 font-light leading-relaxed">정자 가라오케·정자 하이퍼블릭 중심으로 정자역·정자 카페거리 라인을 소개합니다.<br />셔츠룸·호빠·기모노룸·룸살롱까지 목적별로 매칭해 드립니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 문의 부탁드립니다.</p>
                        <div className="flex flex-col sm:flex-row gap-5 justify-center">
                            ...
                            >
                                ...
                                <span className="relative flex items-center justify-center gap-2">
                                    <Phone size={20} className="group-hover:animate-bounce" /> VIP 예약하기 (정자 상권 기준)
                                </span>
                            </button>
                            <Link
                                to="/jeongja-highpub-guide"
            ...
            <section id="features" className="py-24 bg-slate-950 container mx-auto px-4 relative">
                ...
                <SectionTitle title="왜 전문 컨설팅인가?" subtitle="차별화된 가치" /> (정자 상권 기준)
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <FeatureItem icon={ShieldCheck} title="투명한 가격 구조" desc="사전에 명확한 비용 안내로 예상치 못한 추가금을 방지합니다." delay={0} /> (정자 상권 기준)
                    <FeatureItem icon={Users} title="취향 기반 매칭" desc="고객 성향과 니즈를 분석하여 최적의 파트너를 연결해 드립니다." delay={100} /> (정자 상권 기준)
                    <FeatureItem icon={Crown} title="15년 업계 경험" desc="오랜 경험과 네트워크를 바탕으로 신뢰할 수 있는 정보를 제공합니다." delay={200} /> (정자 상권 기준)
                    <FeatureItem icon={Car} title="편리한 이동 지원" desc="정자 전 지역 이동 편의를 위한 픽업 서비스를 운영합니다." delay={300} />
                </div>
            </section>
            ...
            <section className="py-24 bg-slate-950 overflow-hidden">
                <div className="container mx-auto px-4 mb-16 text-center">
                    <span className="text-amber-500 font-bold tracking-[0.3em] uppercase mb-4 block animate-pulse">프리미엄 파트너 라인업 (정자 상권 기준)</span>
                    <h2 className="text-4xl md:text-6xl font-extrabold text-white leading-tight break-keep">
                        다양한 스타일의 <br className="md:hidden" />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-400 to-amber-600">매력적인 파트너</span> 상시 대기 (정자 상권 기준)
                    </h2>
                    <p className="mt-6 text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed break-keep">
                        정자 지역 최고 수준의 네트워크를 바탕으로<br />
                        다양한 스타일의 파트너를 보유하고 있습니다.<br className="hidden md:block" /><br /> (정자 상권 기준)
                        고객님의 취향과 성향을 세심하게 파악하여<br />
                        <strong className="text-white">최적의 파트너십을 경험하실 수 있도록</strong><br className="md:hidden" /> 맞춤형 매칭을 제공합니다. (정자 상권 기준)
                    </p>
                ...
                <div className="relative flex overflow-hidden">
                    <div className="flex animate-infinite-scroll whitespace-nowrap group hover:[animation-play-state:paused]">
                        ...
                        {[
                            ...
                            { src: '/partner/partner-03.webp', alt: '정자 가라오케 VIP 매니저 - 정자역 프리미엄' },
                            ...
                            { src: '/partner/partner-01.webp', alt: '정자 가라오케 프리미엄 매니저 - 서우실장 엄선 파트너' },
                            { src: '/partner/partner-02.webp', alt: '정자 하이퍼블릭 최고급 매니저 - 정자동 서우실장 추천' },
                            { src: '/partner/partner-03.webp', alt: '정자 가라오케 VIP 매니저 - 정자동 라운지' },
                            { src: '/partner/partner-04.webp', alt: '정자 하이퍼블릭 프리미엄 파트너 - 정자역 서우실장' },
                            { src: '/partner/partner-05.webp', alt: '정자 셔츠룸 인기 매니저 - 서우실장 베스트 초이스' },
                            { src: '/partner/partner-06.webp', alt: '정자 하이퍼블릭 엄선 매니저 - 정자 서우실장' },
                            { src: '/partner/partner-07.webp', alt: '정자 가라오케 TOP 매니저 - 정자동 서우실장 추천' },
            ...
            <section className="py-24 md:py-32 relative md:bg-fixed bg-center bg-cover" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1560624052-449f5ddf0c31?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')" }}>
                ...
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-16 relative z-10">
                    <div className="md:w-1/2 order-2 md:order-1">
                        <span className="text-amber-500 font-bold tracking-widest uppercase mb-2 block">1인 방문 가이드 (정자 상권 기준)</span>
                        <h3 className="text-4xl md:text-5xl font-bold text-white mb-8 leading-tight">
                            혼자 방문해도<br />편안합니다
                        </h3>
                        <div className="space-y-6 text-slate-300 text-lg font-light leading-relaxed">
                            <p>
                                최근 <strong className="text-white">1인 방문 고객이 40% 이상</strong>을 차지합니다.<br /> (정자 상권 기준)
                            ...
                            <p>
                                ...
                                가장 어울리는 파트너와 <strong className="text-amber-500">최적의 시간</strong>을 설계해 드립니다. (정자 상권 기준)
                            </p>
                        </div>

                        <div className="mt-10 grid grid-cols-2 gap-4">
                            {[
                                "1인 방문 절대 환영", "24시간 항시 대기", "프라이빗 룸 완비", "맞춤형 파트너 추천" (정자 상권 기준)
                            ].map((item, idx) => (
                        ...
                        <div className="relative">
                            ...
                            <div className="aspect-[4/5] md:h-[500px] bg-slate-800 rounded-2xl overflow-hidden relative border border-slate-700 shadow-2xl md:transform md:rotate-2 hover:rotate-0 transition-transform duration-700">
                                ...
                                <div className="absolute bottom-0 p-8">
                                    <h3 className="text-3xl font-bold text-white">프라이빗 룸 (정자 상권 기준)</h3>
                                    <p className="text-amber-500 font-bold tracking-widest uppercase text-sm">럭셔리 & 시크릿 (정자 상권 기준)</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-24 container mx-auto px-4">
                <SectionTitle title="제휴 업소 안내" subtitle="정자 유흥 핫플레이스" />
            ...
            <section className="py-20 bg-slate-900/50 border-t border-slate-800">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-3xl font-bold text-white">실시간 예약 문의 (정자 상권 기준)</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        ...
                        <a href="tel:01026264833" className="group bg-slate-800/50 p-6 rounded-2xl border border-slate-700 hover:border-amber-500/50 transition-all hover:-translate-y-1 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-white font-bold text-lg">전화 문의 (정자 상권 기준)</h3>
