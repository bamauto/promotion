...
const KaraokeFAQ = () => {
    const faqList = [
    {
        question: "평택 가라오케는 어떤 흐름으로 이용하나요?",
        answer: "예약 후 룸 배정 → 기본 세팅 → 노래 및 파티 진행 순으로 안내됩니다."
    },
    {
        question: "단체나 회식도 가능한가요?",
        answer: "가능합니다. 평택·평택 테크 직장인 회식 수요가 많아 단체 룸도 준비되어 있습니다."
    },
    {
        question: "픽업 가능 지역은 어디인가요?",
        answer: "평택역, 평택역 상권, 평택 산업단지, 구성역 주변 중심으로 운영됩니다."
    },
    {
    ...
    },
    {
        ...
        answer: "가능은 하지만 평택 상권 기준은 대기 발생 가능성이 있어 예약을 추천드립니다."
    },
    {
                ...
                <div className="container mx-auto max-w-4xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400 text-lg leading-relaxed max-w-2xl mx-auto">
                            노래, 술, 파티가 있는 곳. <strong className="text-white">평택 가라오케</strong>를 200% 즐기는 방법을 알려드립니다.
                        </p>
                    </div>
