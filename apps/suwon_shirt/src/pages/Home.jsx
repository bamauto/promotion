...
const Home = () => {
    ...
    const venues = [
        { id: 'suwon-shirt-shirtsroom-guide', title: '셔츠룸', sub: '초이스 / 화이트셔츠', img: '/shirtsroom_main.webp', desc: '수원역·인계동 빠른 초이스' },
        { id: 'suwon-shirt-highpub-guide', title: '하이퍼블릭', sub: '프라이빗 / 시크릿', img: '/highpublic_main.webp', desc: '인계동 중심 프라이빗 라운지' },
        { id: 'suwon-shirt-karaoke-guide', title: '가라오케', sub: '프리미엄 / 라운지', img: '/karaoke_main.webp', desc: '수원역 상권 파티/모임 룸' },
        { id: 'suwon-shirt-kimono-room-guide', title: '기모노룸', sub: '이색 테마 / 코스프레', img: '/kimonoroom_main.webp', desc: '인계동 테마 포인트' },
        { id: 'suwon-shirt-room-salon-guide', title: '룸살롱', sub: '정통 / 비즈니스', img: '/roomsalon_main.webp', desc: '수원역 비즈니스 라인' },
        { id: 'suwon-shirt-hostbar-guide', title: '호빠', sub: '프리미엄 / 여성전용', img: '/hostbar_main.webp', desc: '인계동 상권 여성전용 라운지' }
    ];
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image:alt" content="수원 셔츠룸·인계동 셔츠룸 메인 가이드" />
                ...
                <div className="relative z-10 container mx-auto px-4 text-center mt-10">
                    <div className="animate-fade-in-up">
                        <span className="inline-flex items-center gap-2 border border-amber-500/30 bg-amber-900/10 backdrop-blur-md text-amber-400 px-6 py-2 rounded-full text-xs font-bold tracking-[0.2em] mb-8 uppercase hover:bg-amber-900/20 transition-colors cursor-default">
                            <Crown size={12} fill="currentColor" /> 수원 셔츠룸 컨설팅 전문
                        </span>
                        ...
                        <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto mb-12 font-light leading-relaxed">수원 셔츠룸·인계동 셔츠룸 중심으로 수원역·인계동 상권 라인을 소개합니다.<br />하이퍼블릭·가라오케·호빠·룸살롱까지 목적별로 매칭해 드립니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 문의 부탁드립니다.</p>
                        <div className="flex flex-col sm:flex-row gap-5 justify-center">
                            ...
                            <Link
                                to="/suwon-shirt-shirtsroom-guide"
            ...
            <section className="py-24 bg-slate-950 overflow-hidden">
                <div className="container mx-auto px-4 mb-16 text-center">
                    ...
                    <p className="mt-6 text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed break-keep">
                        수원·인계동 지역 최고 수준의 네트워크를 바탕으로<br />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                        ...
                        <article className="bg-slate-800/30 p-8 rounded-2xl border border-slate-700 hover:border-amber-500/30 transition-all">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-xl font-bold text-white">삼성 디지털시티 인접</h3>
                            </div>
                            <p className="text-slate-300 leading-relaxed">
                                <strong className="text-amber-400">삼성전자·삼성SDI</strong> 본사가 위치한 수원역 인근은
                                대한민국 IT 산업의 중심지입니다. 고소득 엔지니어들의
                        ...
                        <article className="bg-slate-800/30 p-8 rounded-2xl border border-slate-700 hover:border-amber-500/30 transition-all">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-xl font-bold text-white">인계동 유흥 중심지</h3>
                            </div>
                            <p className="text-slate-300 leading-relaxed">
                                <strong className="text-amber-400">인계동·수원역</strong>은
                                경기 남부 최대 유흥 상권.
                                <strong className="text-white">맛집골목·카페거리</strong> 인근에서
                        ...
                        <article className="bg-slate-800/30 p-8 rounded-2xl border border-slate-700 hover:border-amber-500/30 transition-all">
                            ...
                            <p className="text-slate-300 leading-relaxed">
                                평균 연령 <strong className="text-amber-400">28~35세</strong> IT 전문직이 밀집한 수원.
                        ...
                        <article className="bg-slate-800/30 p-8 rounded-2xl border border-slate-700 hover:border-amber-500/30 transition-all">
                            ...
                            <p className="text-slate-300 leading-relaxed">
                                수원은 <strong className="text-amber-400">비즈니스 미팅·협력사 접대</strong>의 핫플레이스.
            ...
            <section className="py-24 container mx-auto px-4">
                <SectionTitle title="제휴 업소 안내" subtitle="수원 셔츠룸 핫플레이스" />
