    ...
    hostbar: [
        {
            ...
            desc: '수지역 인근 여성 전용 호빠. 프라이빗하게 즐기는 라운지.',
            features: ['여성 전용', '프라이빗 라운지', '수지역 접근', '안정적 분위기'],
        ...
        },
        {
            ...
            location: '수지호수공원 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지호수공원 중심 감각적인 호빠. 모던한 분위기와 포토존.',
            features: ['포토존', '감각적인 무드', '수지호수공원 중심', '트렌디'],
            img: '/suji-hostbar-2.webp',
            imgAlt: '수지 호빠 수지호수공원 추천',
        },
        {
            id: 'hb-3',
            name: '수지 호빠 C점',
            ...
            location: '수지센트럴파크 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지센트럴파크 주변 프라이빗 룸. 대화 위주 맞춤 케어.',
            features: ['맞춤 대화', '차분한 룸', '수지센트럴파크 인근', '힐링 코스'],
            img: '/suji-hostbar-1.webp',
            imgAlt: '수지 호빠 수지센트럴파크 추천',
        },
        {
            id: 'hb-4',
            name: '수지 호빠 D점',
            ...
            location: '상현역 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '상현역 인근 캐주얼 라인. 부담 없이 시작하는 코스.',
            features: ['캐주얼 라인', '가벼운 시작', '상현역 인근', '편안한 시간'],
            img: '/suji-hostbar-2.webp',
            imgAlt: '수지 호빠 상현역 추천',
        }
    ]
...
const Hostbar = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "수지 호빠 예약 안내. 수지호수공원·수지센트럴파크 여성전용 라운지, 주대 18만원 이상/TC 10만원 이상.",
        "https://sujikaraoke.com/suji-hostbar-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>수지 호빠 | 여성 전용 프리미엄 호스트바</title>
                <meta name="description" content="수지 호스트바 예약. 죽전역 인근, 여성 전용 안전 서비스. 분당·판교 직장인 걸스나잇 인기 ☎ 010-2626-4833" />
                <meta name="keywords" content="수지 호빠, 수지 호스트바, 죽전 호빠, 용인 호빠, 분당 호빠, 여성 전용 호빠" />
                <meta property="og:title" content="수지 호빠 | 여성 전용 프리미엄 호스트바" />
                <meta property="og:description" content="수지 호스트바 예약. 죽전역 인근, 여성 전용 안전 서비스. 분당·판교 직장인 걸스나잇 인기." />
                <meta property="og:image" content="https://sujikaraoke.com/og-hostbar.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="수지 호빠 | 여성 전용 프리미엄 호스트바" />
                <meta property="twitter:description" content="수지 호스트바 예약. 죽전역 인근, 여성 전용 안전 서비스." />
                <meta property="twitter:image" content="https://sujikaraoke.com/og-hostbar.jpg" />
                <link rel="canonical" href="https://sujikaraoke.com/suji-hostbar-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="수지 호빠(Hostbar) 가이드" subtitle="Private for Ladies" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">수지 호빠(호스트바)는 수지호수공원·수지센트럴파크 중심 여성 고객 라운지로 운영됩니다.<br />프라이빗 코스와 맞춤 대화 중심으로 안내합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="definition" title="1. 수지 호빠 시스템">
                        <p>
                            수지 호스트바는 오직 여성 고객님들만을 위한 프라이빗 유흥 공간입니다.
                            신분당선으로 강남역 25분, 분당선으로 판교·정자 10분 거리로 접근성이 뛰어납니다.
                            강남 '정빠' 퀄리티를 유지하면서도 분당·판교 여직원분들의 합리적인 눈높이에 맞춘 가격대가 장점입니다.
                        </p>
                        <p>
                            죽전·수지구청역 인근 젊은 직장인들의 브라이덜샤워, 걸스나잇, 생일파티 명소로 입소문이 나면서
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-rose-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 수지 호빠 추천 업소</h2>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-rose-800 to-pink-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">수지에서 당신만을 위한 왕자님이 기다립니다</h2>
