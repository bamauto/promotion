...
const services = [
    ...
    },
    {
        ...
        name: '셔츠룸',
        desc: '화이트 셔츠의 매력',
        path: '/gwanggyo-shirtsroom-guide',
        icon: Shirt,
        color: 'text-white'
    },
    {
        ...
        name: '기모노룸',
        desc: '이색적인 코스튬 테마',
        path: '/gwanggyo-kimono-room-guide',
        icon: Flower2,
        color: 'text-pink-400'
    },
    {
        ...
        name: '룸살롱',
        desc: '비즈니스 접대의 정석',
        path: '/gwanggyo-room-salon-guide',
        icon: Crown,
        ...
        <section className="py-20 bg-slate-900 border-t border-slate-800">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-slate-400">광교 최고의 밤문화 코스를 확인해보세요.</p>
                </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-bold text-white group-hover:text-amber-400 transition-colors">광교 {service.name}</h4>
