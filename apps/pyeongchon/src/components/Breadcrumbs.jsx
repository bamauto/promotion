...
const routeNameMap = {
    'pyeongchon-highpub-guide': '하이퍼블릭',
    'pyeongchon-karaoke-guide': '가라오케',
    'pyeongchon-shirtsroom-guide': '셔츠룸',
    'pyeongchon-kimono-room-guide': '기모노룸',
    'pyeongchon-room-salon-guide': '룸살롱',
    'pyeongchon-hostbar-guide': '호빠',
    'pyeongchon-entertainment-price-guide': '가격 가이드',
    'pyeongchon-entertainment-beginner-guide': '초보자 가이드',
    'faq': 'FAQ',
    'contact': '문의하기',
    'terms': '이용약관',
    'privacy': '개인정보처리방침'
...
const Breadcrumbs = () => {
    ...
    pathnames.forEach((name, index) => {
        ...
        schemaItems.push({
            ...
            "position": index + 2,
            "name": routeName,
            "item": `https://pc-karaoke.com${routeTo}`
        });
    });
