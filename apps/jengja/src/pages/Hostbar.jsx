    ...
    hostbar: [
        {
            ...
            name: '정자 프리미엄 호빠',
            type: 'Wild & Sexy',
            location: '정자 분당역 AK플라자 6번 게이트',
            price: '여성전용 특가',
            desc: '야성을 깨우는 짐승남들의 핫한 퍼포먼스. 분당역 메인 상권에 위치하여 접근성이 좋으며, 파워풀하고 에너지 넘치는 선수들이 스트레스를 확실하게 풀어드립니다.',
            features: ['근육질 선수', '퍼포먼스 쇼', '생일 샴페인', '픽업 서비스'],
            img: venueImg1,
            imgAlt: '정자 프리미엄 호빠 인테리어'
        },
        {
            id: 'hb-2',
            name: '정자동 로맨틱 호빠',
            type: 'Flower Boys',
            location: '정자 정자동 엠코헤리츠',
            price: '풀코스 180,000원 ~',
...
const Hostbar = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "정자 호스트바 추천 및 가격. 여성 전용 프라이빗 룸 및 픽업 서비스.",
        "https://www.jengjakaraoke.com/jeongja-hostbar-guide",
        "150000"
    );
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image" content="https://www.jengjakaraoke.com/og-hostbar.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="정자 호스트바 문화 가이드" />
                <meta property="twitter:description" content="여성 라운지 선택 | 안전 이용 | 에티켓 안내" />
                <meta property="twitter:image" content="https://www.jengjakaraoke.com/og-hostbar.jpg" />
                <link rel="canonical" href="https://www.jengjakaraoke.com/jeongja-hostbar-guide" />
            </Helmet>
