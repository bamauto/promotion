    ...
    hostbar: [
        {
            ...
            name: '안양 호빠 A점',
            type: 'Wild & Sexy',
            location: '평촌 신도시 AK플라자 6번 게이트',
            price: '여성전용 특가',
            desc: '야성을 깨우는 짐승남들의 핫한 퍼포먼스. 평촌역·범계역 메인 상권에 위치하여 접근성이 좋으며, 파워풀하고 에너지 넘치는 선수들이 스트레스를 확실하게 풀어드립니다.',
            features: ['근육질 선수', '퍼포먼스 쇼', '생일 샴페인', '픽업 서비스'],
            img: '/anyang-hostbar-1.webp',
            imgAlt: '안양 호빠 A점 프리미엄 룸'
        },
        {
            id: 'hb-2',
            name: '안양 호빠 B점',
            type: 'Flower Boys',
            location: '평촌역·범계역 인근 엠코헤리츠',
            price: '풀코스 150,000원 ~',
            ...
            imgAlt: '안양 호빠 B점 로맨틱 룸'
        },
        {
            id: 'hb-3',
            name: '안양 호빠 C점',
            type: 'Model Club',
            location: '평촌동·범계동 인근 인근',
            price: '고급 양주 SET',
            ...
            img: '/anyang-hostbar-1.webp',
            imgAlt: '안양 호빠 C점 모델클럽'
        },
        {
            id: 'hb-4',
            name: '안양 호빠 D점',
            type: 'Casual Pub',
            location: '청계동 인근 먹자골목',
            price: '소주/맥주 SET',
...
const Hostbar = () => {
    const faqList = [
        ...
        },
        {
            ...
            answer: "강남 정빠 출신부터 아이돌 연습생, 모델 출신 등 안양 최고 수질을 자부합니다. 취향에 맞춰 초이스 하실 수 있습니다."
        }
    ];
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "안양 호스트바 추천 및 가격. 여성 전용 프라이빗 룸 및 픽업 서비스.",
    ...
    return (
        <>
            <Helmet>
                <title>안양 호빠·여성전용클럽 완벽가이드 | 신혼부부·걸스파티 BEST 4곳</title>
                <meta name="description" content="안양 호빠 가이드. 안양 전문직 여직원 회식, 평촌 신도시 신혼부부 브라이덜샤워, 걸스나잇 맞춤. 아이돌급·모델출신 선수 무한초이스. 평촌역·범계역 4호선 5분거리 픽업. 철저한 비밀보장 ☎ 010-2626-4833" />
                <meta name="keywords" content="안양 호빠, 안양 호스트바, 안양 여성클럽, 안양 정빠, 평촌 신도시 호빠, 평촌역·범계역 호빠, 여직원회식, 걸스파티, 브라이덜샤워, 안양 신혼부부" />
                <meta property="og:title" content="안양 호빠·여성클럽 | 신혼부부·걸스파티 BEST" />
                <meta property="og:description" content="평촌 신도시 여성전용 프리미엄. 아이돌급 선수 무한초이스·GTX-A 픽업 ☎ 010-2626-4833" />
                ...
                <meta property="twitter:title" content="안양 호빠 | 신혼부부·걸스파티 BEST 4곳" />
                <meta property="twitter:description" content="평촌 신도시 여성전용 클럽 | 아이돌급 선수 | 비밀보장 | GTX-A 픽업" />
                ...
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    ...
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">
                            ...
                            평촌 신도시 신혼부부·안양 전문직 여직원분들을 위한<br />
                            최고의 비주얼과 매너를 갖춘 선수들이 설렘으로 가득 채워드립니다.
                        </p>
                    </div>
