...
const venues = {
    hostbar: [
        ...
        },
        {
            ...
            price: '주대 18만원 이상 · TC 10만원 이상 (자세한 상담)',
            desc: '평촌역·평촌1번가 근처 캐주얼 라인. 부담 없이 시작하는 코스.',
            features: ['캐주얼 라인', '가벼운 시작', '평촌역·평촌1번가 근처', '편안한 시간'],
            img: '/pyeongchon-hostbar-2.webp',
            imgAlt: '평촌 호빠 평촌역·평촌1번가 추천',
        }
    ]
};
...
const Hostbar = () => {
    const faqList = [
    {
        question: "범계 로데오에서 여성 혼자 방문해도 안전한가요?",
        answer: "범계역·평촌역 인근은 대로변 상권으로 CCTV와 가로등이 밝게 켜져 있어 안전합니다. 귀가 시 역까지 무료 픽업 서비스도 제공하니 안심하고 방문해 주세요."
    },
    {
        question: "브라이덜샤워·걸스나잇 예약이 가능한가요?",
        answer: "평촌 신도시 2030 여성들의 브라이덜샤워·걸스나잇·생일파티 명소입니다. 미리 예약하시면 룸 데코레이션과 축하 공연 이벤트를 무료로 준비해 드립니다."
    },
    {
        question: "강남 호빠 대비 선수 수질은 어떤가요?",
        answer: "강남 대비 30% 저렴하면서 동일한 아이돌급·모델 출신 선수 라인업을 보유하고 있습니다. 비용 대비 만족도가 매우 높아 단골 고객이 많습니다."
    },
    {
        question: "평촌 신도시 여성 전문직(IT·교육·의료) 고객도 많나요?",
        answer: "인덕원 IT단지, 평촌학원가, 평촌중앙병원 인근 여성 전문직 고객분들이 많이 방문하십니다. 퇴근 후 스트레스 해소 장소로 인기가 높습니다."
    }
];

    const sections = [
        { id: "definition", title: "1. 평촌 호빠 시스템" },
    ...
    const serviceSchema = generateServiceSchema(
        "Host Bar",
        "평촌 호빠 예약 안내. 평촌역·인덕원역 여성전용 라운지, 주대 18만원 이상/TC 10만원 이상.",
        "https://pc-karaoke.com/pyeongchon-hostbar-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>평촌 호빠 예약 | 평촌역·인덕원역 여성전용</title>
                <meta name="description" content="평촌 호빠(호스트바) 안내. 평촌역·인덕원역 중심 프라이빗 라운지, 여성 고객 맞춤. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta name="keywords" content="평촌 호빠, 평촌 호스트바, 평촌 호빠 예약, 평촌 가라오케" />
                <meta property="og:title" content="평촌 호빠 예약 | 평촌역·인덕원역 여성전용" />
                <meta property="og:description" content="평촌 호빠(호스트바) 안내. 평촌역·인덕원역 중심 프라이빗 라운지, 여성 고객 맞춤. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="og:image" content="https://pc-karaoke.com/og-hostbar.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="평촌 호빠 예약 | 평촌역·인덕원역 여성전용" />
                <meta property="twitter:description" content="평촌 호빠(호스트바) 안내. 평촌역·인덕원역 중심 프라이빗 라운지, 여성 고객 맞춤. 주대 18만원 이상, TC 10만원 이상, 상세 문의." />
                <meta property="twitter:image" content="https://pc-karaoke.com/og-hostbar.jpg" />
                <link rel="canonical" href="https://pc-karaoke.com/pyeongchon-hostbar-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="평촌 호빠(Hostbar) 가이드" subtitle="Private for Ladies" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">평촌 호빠(호스트바)는 평촌역·인덕원역 중심 여성 고객 라운지로 운영됩니다.<br />프라이빗 코스와 맞춤 대화 중심으로 안내합니다.<br />주대 18만원 이상·TC 10만원 이상 기준이며 상세 견적은 문의 부탁드립니다.</p>
                    </div>

                    <TableOfContents sections={sections} />

                    {/* 1. Definition */}
                    <ContentBlock id="definition" title="1. 평촌 여성 친화 상권의 중심">
                        <p>
                            평촌은 <strong className="text-rose-400">경기 남부 여성 친화 유흥 상권</strong>의 중심입니다.
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-rose-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 평촌 호빠 추천 업소</h2>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-rose-800 to-pink-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">평촌에서 당신만을 위한 왕자님이 기다립니다</h2>
