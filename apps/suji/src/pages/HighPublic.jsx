    ...
    highPublic: [
        {
            ...
            desc: '수지역 중심의 모던한 하이퍼블릭. 수지 신도시 직장인의 조용한 접대/술자리에 맞춘 프라이빗 라운지.',
            features: ['프라이빗 예약', '조용한 라운지', '수지역 접근', '비즈니스 동선'],
            img: '/suji-shirtsroom-2.webp',
            imgAlt: '수지 하이퍼블릭 수지역 추천',
        },
        {
            id: 'hp-2',
            name: '수지 하이퍼블릭 B점',
            ...
            location: '수지호수공원 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지호수공원 인근 대형 구성. 신도시 감성 분위기와 파티형 세팅으로 단체 모임에 적합.',
            features: ['대형 룸', '파티 조명', '수지호수공원 중심', '단체 환영'],
            img: '/suji-karaoke-1.webp',
            imgAlt: '수지 하이퍼블릭 수지호수공원 추천',
        },
        {
            id: 'hp-3',
            name: '수지 하이퍼블릭 C점',
            ...
            location: '수지센트럴파크 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '수지센트럴파크 주변 비즈니스 타입. 대화 중심 세팅과 방음 룸으로 차분한 자리.',
            features: ['방음 룸', '라운지 톤', '수지센트럴파크 인근', '대화 중심'],
            img: '/suji-nightlife-2.webp',
            imgAlt: '수지 하이퍼블릭 수지센트럴파크 추천',
        },
        {
            id: 'hp-4',
            name: '수지 하이퍼블릭 D점',
            ...
            location: '상현역 인근',
            price: '주대 18만원 이상 / TC 10만원 이상, 자세한 사항 문의',
            desc: '상현역 인근 캐주얼 라인. 가볍게 즐기는 분위기와 유연한 동선.',
            features: ['캐주얼 무드', '유연한 코스', '상현역 인근', '가벼운 모임'],
            img: '/suji-roomsalon-1.webp',
            imgAlt: '수지 하이퍼블릭 상현역 추천',
        }
    ]
};
...
const HighPublic = () => {
    ...
    const serviceSchema = generateServiceSchema(
        "HighPublic Club",
        "수지 하이퍼블릭 예약 안내. 수지역·수지호수공원 중심 픽업, 주대 18만원 이상/TC 10만원 이상.",
        "https://sujikaraoke.com/suji-highpub-guide",
        "180000"
    );
    ...
    return (
        <>
            <Helmet>
                <title>수지 하이퍼블릭 | 신분당선 직결 프리미엄 가라오케</title>
                <meta name="description" content="수지구청역 도보 3분 하이퍼블릭. 분당선 환승 편리, 반도체 벨트 접대 전문. VIP룸·프라이빗 서비스. 당일 예약 ☎ 010-2626-4833" />
                <meta name="keywords" content="수지 하이퍼블릭, 수지구청역 하이퍼블릭, 죽전 하이퍼블릭, 신분당선 가라오케, 성복동 하이퍼블릭, 정자역 하이퍼블릭" />
                <meta property="og:title" content="수지 하이퍼블릭 | 신분당선 직결 프리미엄 가라오케" />
                <meta property="og:description" content="수지구청역 도보 3분 하이퍼블릭. 분당선+신분당선 환승 편리. 삼성·SK 반도체 벨트 접대 전문. VIP룸·프라이빗 서비스 완비." />
                <meta property="og:image" content="https://sujikaraoke.com/og-highpub.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:image:alt" content="수지 하이퍼블릭 예약 가이드" />
                <meta property="og:type" content="website" />
                <meta property="og:locale" content="ko_KR" />
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:title" content="수지 하이퍼블릭 | 신분당선 직결 프리미엄 가라오케" />
                <meta property="twitter:description" content="수지구청역 도보 3분 하이퍼블릭. 분당선 환승 편리. 반도체 벨트 접대 전문. VIP룸·프라이빗 서비스." />
                <meta property="twitter:image" content="https://sujikaraoke.com/og-highpub.jpg" />
                <link rel="canonical" href="https://sujikaraoke.com/suji-highpub-guide" />
            </Helmet>
            <SchemaJsonLd data={[serviceSchema, faqSchema]} />

            <div className="pt-24 md:pt-32 min-h-screen bg-slate-950">
                <div className="container mx-auto px-4 pb-12 max-w-6xl">
                    <SectionTitle title="수지 하이퍼블릭 예약 및 가격" subtitle="Premium Service" />

                    {/* Intro Text */}
                    <div className="mb-20 text-center max-w-4xl mx-auto">
                        <p className="text-xl text-slate-300 leading-relaxed font-light">수지 하이퍼블릭은 수지역·수지호수공원 중심으로 수지 신도시 직장인 맞춤 코스를 제공합니다.<br />모던한 무드의 프라이빗 룸과 안정적인 동선, 주대 18만원 이상·TC 10만원 이상 기준으로 안내합니다.<br />상세 견적은 문의 부탁드립니다.</p>
                    </div>
                    ...
                    <ContentBlock id="definition" title="1. 하이퍼블릭이란? (Definition)">
                        ...
                        <p>
                            ...
                            보다 부담 없는 가격으로 즐길 수 있어, 최근 수지 지역 비즈니스 접대 및 모임의 메인 트렌드로 자리 잡았습니다.
                        </p>
                    ...
                    <div id="recommendation" className="mb-24">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1.5 h-8 bg-amber-500 rounded-full"></div>
                            <h2 className="text-3xl font-bold text-white">2. 수지 하이퍼블릭 추천 TOP 2</h2>
                        </div>
                        ...
                        <div className="mt-16">
                            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                                <Sparkles className="text-amber-500" /> 수지 하이퍼블릭 갤러리
                            </h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    { src: '/partner/hp-gallery-01.webp', alt: '수지 하이퍼블릭 프리미엄 매니저 - 수지역 VIP 서비스' },
                                    { src: '/partner/hp-gallery-02.webp', alt: '수지 하이퍼블릭 최고급 파트너 - 메타폴리스 럭셔리 룸' },
                                    { src: '/partner/hp-gallery-03.webp', alt: '수지 하이퍼블릭 VIP 매니저 - 죽전역 인근 프리미엄' },
                                    { src: '/partner/hp-gallery-04.webp', alt: '수지 하이퍼블릭 프리미엄 서비스 - 수지 24시간' },
                                ].map((img, idx) => (
                    ...
                    <ContentBlock id="system" title="3. 이용 시스템 및 가이드">
                        <p>
                            수지 하이퍼블릭을 처음 방문하시나요? 투명한 이용을 위해 기본적인 시스템을 안내해 드립니다. 대부분의 업소가 비슷한 룰을 따르고 있으나, <strong>서우실장</strong>을 통해 예약하시면 더욱 특별한 혜택을 받으실 수 있습니다.
                        </p>
                    ...
                    <div id="faq" className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
                        ...
                        <div className="bg-amber-900/10 p-8 rounded-2xl border border-amber-500/20">
                            ...
                            <div className="mt-6 text-center">
                                <Link to="/suji-highpub-guide/faq" className="inline-flex items-center gap-2 text-amber-500 hover:text-amber-400 font-bold transition-colors">
                    ...
                    <div className="bg-gradient-to-r from-amber-600 to-amber-700 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 relative z-10">오늘 밤, 수지에서 최고의 주인공이 되어보세요</h2>
                        <p className="text-amber-100 mb-8 max-w-2xl mx-auto relative z-10">
                            고민은 즐거움만 늦출 뿐입니다. 지금 바로 전화주세요.<br />
                            수지 No.1 서우실장이 책임지고 모시겠습니다.
                        </p>
